...
B.define("caret", function() {
    ...
    return _r_({
        ...
        setPosition: function(e, t) {
            ...
            (i = document.selection.createRange()).moveStart("character", -e.value.length),
            i.moveStart("character", t),
            i.moveEnd("character", 0),
            i.select()) : (e.selectionStart || 0 === e.selectionStart) && (e.selectionStart = t,
            e.selectionEnd = t,
            e.focus()),
            _r_()
        },
        setSelection: function(e, t, i) {
            ...
            !e)
                return _r_();
            document.selection ? (e.focus(),
            (n = document.selection.createRange()).moveStart("character", -e.value.length),
            n.moveStart("character", t),
            n.moveEnd("character", i - t),
            n.select()) : (e.selectionStart || 0 === e.selectionStart) && (e.selectionStart = t,
            e.selectionEnd = i,
            e.focus()),
            _r_()
        },
...
B.define("click-out", function(e, t, i) {
    ...
    t.addMonitor = function(e, t) {
        ...
        _i_("4ab:c17566ca"),
        n || (n = !0,
        document.documentElement.addEventListener ? document.documentElement.addEventListener("click", a) : document.documentElement.attachEvent && document.documentElement.attachEvent("onclick", a)),
        _r_();
        var i = Math.random();
        return "string" == typeof e.jquery && (e = e[0]),
        setTimeout(function() {
            _i_("4ab:9952e084"),
            s[i] = {
                element: e,
...
B.define("deny-focus", function(e, t, i) {
    ...
    _r_({
        ...
        _denyFocusOn: [],
        _get: function(t) {
            return _i_("4ab:49251ead"),
            _r_(this._denyFocusOn.filter(function(e) {
                if (_i_("4ab:5bd98b23"),
                e.el === t)
                    return _r_(!0);
                return _r_(!1)
        ...
        _add: function(e) {
            ...
            return this._denyFocusOn.push(i),
            _r_(i)
        },
        _update: function(e) {
            _i_("4ab:3e71e8fe");
        ...
        _buildAttributesObject: function(e) {
            return _i_("4ab:9f219c08"),
            _r_(e.map(function(t) {
                _i_("4ab:48092da2");
                var i = {};
        ...
        deny: function(e) {
            if (_i_("4ab:71875e1f"),
            !e || !e instanceof Node)
                return console.log("Please provide a valid DOMElement to deny focus for"),
                _r_(!1);
            var t = this._get(e);
            t ? this._update(t) : t = this._add(e),
            t.focusable.forEach(function(t) {
                _i_("4ab:ead5a0b7"),
...
B.define("keycodes", [], function() {
    ...
    function e(e, t) {
        _i_("4ab:83a52ba4");
        for (var i = [], n = 0; n <= t - e; n++)
            i.push(e + n);
        return _r_(i)
    }
    function a(e, t) {
        if (_i_("4ab:768b926a"),
        Array.isArray(n[e]) && -1 !== n[e].indexOf(t))
            return _r_(!0);
        if (n[e] === t)
            return _r_(!0);
        return _r_(!1)
    ...
    return Object.keys(n).forEach(function(t) {
        ...
        s["is" + (e = t,
        _i_("4ab:2984a907"),
        _r_(e.slice(0, 1).toUpperCase() + e.slice(1)))] = function(e) {
            return _i_("4ab:4209f82c"),
            _r_(i(e, t))
        }
        ,
        _r_()
        ...
        Object.keys(s).forEach(function(e) {
            ...
            !a.attributes[i]) {
                if (t.hasOwnProperty("defaultValue"))
                    ...
                    throw new Error("read-data-options: missing required " + i + " attribute");
                return _r_()
            }
            n = a.getAttribute(i);
            if (t.type === Boolean)
                n = !/^0|false|no|off$/.test(n);
...
B.define("calendar-base", function(e, t, i) {
    ...
    g.prototype.getCalendar = function(e, t) {
        ...
        e = i.getUTCFullYear(),
        t = i.getUTCMonth();
        for (var n, a, s, r, o, _ = [], l = i.getUTCDay(), d = -(7 - this.weekStart + l) % 7, h = g.daysInMonth(e, t), c = (h - d) % 7, u = g.daysInMonth(e, t - 1), f = d, p = h - f + (0 != c ? 7 - c : 0) + d, b = null; f < p; )
            n = ((f < 1 ? 7 + f : f) + l) % 7,
            (a = f + 1) < 1 || h < a ? this.siblingMonths ? (a < 1 ? (o = e,
            (r = t - 1) < 0 && (r = 11,
            o--),
            a = u + a) : h < a && (o = e,
            11 < (r = t + 1) && (r = 0,
            ...
            s && this.weekNumbers && (null === b ? b = g.calculateWeekNumber(s) : 1 == n && 52 == b ? b = 1 : 1 == n && b++,
            s.weekNumber = b),
    ...
    g.prototype.isDateSelected = function(e) {
        if (_i_("4ab:15796b9b"),
        e.year == this.startDate.year && e.month == this.startDate.month && e.day == this.startDate.day)
            return _r_(!0);
        if (this.endDate) {
            if (e.year == this.startDate.year && e.month == this.startDate.month && e.day < this.startDate.day)
                return _r_(!1);
            if (e.year == this.endDate.year && e.month == this.endDate.month && e.day > this.endDate.day)
                return _r_(!1);
            if (e.year == this.startDate.year && e.month < this.startDate.month)
                return _r_(!1);
            if (e.year == this.endDate.year && e.month > this.endDate.month)
                return _r_(!1);
            if (e.year < this.startDate.year)
                return _r_(!1);
            if (e.year > this.endDate.year)
                return _r_(!1);
            return _r_(!0)
        }
        return _r_(!1)
    ...
    g.interval = function(e, t) {
        return _i_("4ab:5f59974d"),
        _r_(Math.abs(g.diff(e, t)) + 1)
    }
    ,
    g.compare = function(e, t) {
        if (_i_("4ab:93d77961"),
        "object" != typeof e || "object" != typeof t || null === e || null === t)
    ...
    g.daysInMonth = function(e, t) {
        return _i_("4ab:d478bc66"),
        _r_(new Date(e,t + 1,0).getDate())
    }
    ,
    g.isLeapYear = function(e) {
        return _i_("4ab:7e93f3c0"),
        _r_(e % 4 == 0 && e % 100 != 0 || e % 400 == 0)
    }
    ,
    g.calculateWeekNumber = function(e) {
        ...
        var a = i.valueOf();
        return i.setUTCMonth(0, 1),
        4 != i.getUTCDay() && i.setUTCMonth(0, 1 + (4 - i.getUTCDay() + 7) % 7),
...
B.define("morphdom", function(e, t, i) {
    ...
    function(e) {
        ...
        var N, t = "undefined" != typeof document ? document.body || document.createElement("div") : {}, j = "http://www.w3.org/1999/xhtml";
        function T(e) {
            for (var t in _i_("4ab:ace7a10f"),
            e)
        ...
        return e.exports = function(e, t, i) {
            ...
            "string" == typeof t)
                if ("#document" === e.nodeName || "HTML" === e.nodeName) {
                    ...
                    a = t,
                    _i_("4ab:6e64c2c2"),
                    !F && document.createRange && (F = document.createRange()).selectNode(document.body),
                    F && F.createContextualFragment ? s = F.createContextualFragment(a) : (s = document.createElement("body")).innerHTML = a,
                    t = _r_(s.childNodes[0]);
            var a, s, b = {}, g = {}, m = i.getNodeKey || J, M = i.onBeforeNodeAdded || A, v = i.onNodeAdded || A, y = i.onBeforeElUpdated || A, B = i.onElUpdated || A, r = i.onBeforeNodeDiscarded || A, o = i.onNodeDiscarded || A, C = i.onBeforeElChildrenUpdated || A, _ = !0 === i.childrenOnly, k = [];
            function l(e) {
                if (_i_("4ab:5e13d614"),
                1 === e.nodeType)
            ...
            function x(e, t, i, n) {
                ...
                !n) {
                    ...
                    if (function(e, t) {
                        ...
                        for (i = _.length - 1; 0 <= i; i--)
                            a = (n = _[i]).name,
                            r = n.value,
                            (s = n.namespaceURI) ? (a = n.localName || a,
                            o = e.getAttributeNS(s, a)) : o = e.getAttribute(a),
                            o !== r && (s ? ("xmlns" === n.prefix && (a = n.name),
                            e.setAttributeNS(s, a, r)) : e.setAttribute(a, r));
                        for (i = (_ = e.attributes).length - 1; 0 <= i; i--)
                            !1 !== (n = _[i]).specified && (a = n.name,
                            s = n.namespaceURI,
                            N(t, s, s ? a = n.localName || a : a) || e.removeAttributeNode(n));
                        _r_()
                    }(e, t),
                    B(e),
                    !1 === C(e, t))
                ...
                if ("TEXTAREA" !== e.nodeName) {
                    var s, r, o, _, l, d = t.firstChild, h = e.firstChild;
                    e: for (; d; ) {
                        for (o = d.nextSibling,
                        s = m(d); h; ) {
                            var c = m(h);
                            ...
                            if (u === d.nodeType) {
                                var f = !1;
                                if (1 === u ? (O(h, d) && (c || s ? s === c && (f = !0) : f = !0),
                                f && x(h, d, i)) : 3 !== u && 8 != u || (f = !0,
                                h.nodeValue = d.nodeValue),
                                f) {
                                    d = o,
                                    h = r;
                                    continue e
            ...
            var d, h, c = e, u = c.nodeType, f = t.nodeType;
            if (!_)
                if (1 === u)
                    1 === f ? O(e, t) || (o(e),
                    c = function(e, t) {
                    ...
                    h = t.namespaceURI,
                    _i_("4ab:b9ab9e43"),
                    _r_(h && h !== j ? document.createElementNS(h, d) : document.createElement(d))))) : c = t;
                else if (3 === u || 8 === u) {
                    if (f === u)
                        return c.nodeValue = t.nodeValue,
                        _r_(c);
                    c = t
                }
            if (c === t)
            ...
            return !_ && c !== e && e.parentNode && e.parentNode.replaceChild(c, e),
            _r_(c)
        }
        ,
        _r_(e.exports)
    ...
    i.exports = {
        parse: function(e) {
            ...
            return e.split(/\s+/).forEach(function(e) {
                _i_("4ab:77d12fd8");
                var t, i = e, n = !0, a = e.indexOf(":");
                -1 !== a && (i = e.substr(0, a),
                (n = e.substr(a + 1)) || (n = 0),
                t = n,
                _i_("4ab:cf893a7a"),
                _r_(!isNaN(parseFloat(t)) && isFinite(t)) && (n = parseInt(n, 10))),
                s[i] = n,
                _r_()
            }),
            _r_(s)
...
B.define("search/modules/search-date", function(e, t, i) {
    ...
    function a(e) {
        ...
        null !== this.month && (this.month < 0 ? this.month = 0 : 11 < this.month && (this.month = 11)),
        null !== this.day && (this.day < 0 ? this.day = 0 : this.day > s(this.year, this.month) && (this.day = s(this.year, this.month))),
        this.complete = null !== this.year && null !== this.month && null !== this.day,
        _r_()
    }
    function s(e, t) {
        return _i_("4ab:1b292207"),
        _r_("number" == typeof e && "number" == typeof t ? n.daysInMonth(e, t) : 3 == t || 5 == t || 8 == t || 10 == t ? 30 : 1 == t ? 29 : 31)
    }
    a.prototype = {
        toString: function() {
            if (_i_("4ab:f1f54d20"),
        ...
        toNative: function() {
            if (_i_("4ab:7bbffa6e"),
            !this.complete)
                return _r_(new Date(NaN));
            return _r_(new Date(Date.UTC(this.year, this.month, this.day, 0, 0, 0, 0)))
        },
        valueOf: function() {
            return _i_("4ab:c9d65c1a"),
            _r_(this.toNative().valueOf())
        }
    },
    a.create = function(e) {
        var t;
        if (_i_("4ab:52ce28b2"),
        "string" == typeof e && 3 == (t = e.split("-")).length && (e = {
    ...
    a.createFlexible = function(e) {
        ...
        "object" != typeof e || null === e)
            throw new TypeError("date must be an object");
        if ("number" != typeof e.year || "number" != typeof e.month || "number" != typeof e.day)
...
B.define("component/autocomplete-core", function(e, t, i) {
    ...
    i.exports = a.extend({
        ...
        addListEventListeners: function() {
            ...
            this.$list.on("click", '[data-list-item=""]', this.listItemClick.bind(this)),
            _r_()
        },
        ...
        inputFocus: function(e) {
            _i_("4ab:50598299"),
            this.options.openFocus && (this.listShow(),
            this.autocomplete({
                fromFocus: !0
            })),
            _r_()
        ...
        inputBlurSync: function() {
            _i_("4ab:1be76dc3"),
            !this.preventBlurClose && this.listVisible && (this.highlightReset(),
            this.reset()),
            _r_()
        },
        ...
        inputKeyUp: function(e) {
            ...
            t || ((n || i) && this.listShow(),
            !this.isDeletion && !i || this.supportsInputEvent || this.autocomplete(),
            i && this.keyDownCount++),
            _r_()
        },
        inputEscape: function(e) {
            _i_("4ab:a63e3a5c"),
            this.listVisible && (e.originalEvent.preventDefault(),
            this.highlightReset(),
            this.reset()),
            _r_()
        },
        ...
        inputEnter: function(e) {
            _i_("4ab:0c057b22"),
            this.listVisible && -1 != this.highlightedIndex && (e.originalEvent.preventDefault(),
        ...
        clickOut: function() {
            _i_("4ab:095cbd45"),
            this.listVisible && (this.highlightReset(),
            this.reset()),
            _r_()
        },
        setValue: function(e) {
        ...
        listShow: function() {
            _i_("4ab:7f0b6848"),
            this.listVisible || this._loading || (this.$list.addClass("-visible"),
            this.listVisible = !0,
        ...
        listHide: function() {
            _i_("4ab:44a78ebb"),
            this.listVisible && (this.$list.removeClass("-visible"),
            this.resetFlags(),
        ...
        highlightPrevious: function() {
            _i_("4ab:5af5b819");
            for (var e = this.highlightedIndex; -1 == e ? e = this.items.length - 1 : e--,
            -1 != e && this.items[e].hidden; )
                ;
            this.highlightFromNavigation(e),
            _r_()
        },
        highlightNext: function() {
            _i_("4ab:57b7aad5");
            for (var e = this.highlightedIndex; e == this.items.length - 1 ? e = -1 : e++,
            -1 != e && this.items[e].hidden; )
                ;
            this.highlightFromNavigation(e),
            _r_()
        ...
        highlightFromNavigation: function(e, t, i) {
            if (_i_("4ab:1de2a5d2"),
            (-1 == this.highlightedIndex || t) && (this.valueBuffer = this.input.value),
            -1 == e)
                this.highlightReset({
                    preserveFocus: !0
                });
                ...
                if (this.valueBuffer && 0 == this.items[e].valueLowerCase.indexOf(this.valueBuffer.toLowerCase())) {
                    ...
                    if (this.input.value == s || i || this.setValue(s),
                    ...
                    i || (this.setValue(this.items[e].value),
                    this.fixIEFocusLoss());
            this.highlight(e),
            _r_()
        },
        highlightFromAutocomplete: function() {
            ...
            -1 !== t && this.options.highlightFirst && !this.isDeletion && e && 0 === this.items[t].valueLowerCase.indexOf(e.toLowerCase()) || this.options.forceHighlight ? this.highlightFromNavigation(t, !0) : this.highlight(-1),
            _r_()
        },
        highlight: function(e) {
            _i_("4ab:afe25219"),
            this.listShow(),
            -1 != this.highlightedIndex && this.$items.eq(this.highlightedIndex).removeClass(this.highlightClass),
        ...
        highlightReset: function(e) {
            _i_("4ab:1ee32de1"),
            e = e || {},
            null === this.valueBuffer || e.preserveInputValue || (this.setValue(this.valueBuffer),
        ...
        highlightScroll: function() {
            ...
            if (-1 != this.highlightedIndex) {
                ...
                e = 0;
            !1 !== e && e != t && (this.$list[0].scrollTop = e),
            _r_()
        },
        getListLength: function() {
            return _i_("4ab:257516ce"),
            _r_(this.items.length)
        },
        getListFirstIndex: function() {
            return _i_("4ab:bd23caef"),
            0 === this.items.length ? _r_(-1) : _r_(0)
        },
        ...
        choose: function(e) {
            ...
            B.env.fe_s_prprtyt ? this.selectedValue = this.items[e].valueWithPropertyType ? this.items[e].valueWithPropertyType : this.items[e].value : this.selectedValue = this.items[e].value,
    ...
    return _r_(n.extend({
        init: function() {
            ...
            t.filter(function(e, t) {
                return _i_("4ab:bbabec74"),
                _r_(!!$(t).attr("placeholder"))
            }).each(function(e, t) {
                _i_("4ab:c0314b00"),
                this.setupPlaceholder($(t)),
                _r_()
            }
            .bind(this)),
            _r_()
        ...
        setupPlaceholder: function(e) {
            ...
            this.options.placeholderClass && t.addClass(this.options.placeholderClass),
            t.insertBefore(e),
            t.click(function() {
                _i_("4ab:8b3ebc9a"),
                e.focus(),
            ...
            e.get(0) === document.activeElement ? e.triggerHandler("focus") : e.triggerHandler("blur"),
            _r_()
        }
    }))
}),
B.define("component/keyboard", function(e, t, i) {
    ...
    function r(i, n) {
        return _i_("4ab:c305199b"),
        _r_(function(e) {
            _i_("4ab:89331456");
            var t = "";
            e.which && void 0 !== s[e.which.toString()] && (e.originalEvent.altKey && (t += ":alt"),
    ...
    i.exports = n.extend({
        init: function() {
            _i_("4ab:70caa689"),
            a.extend(this),
            this.$el.bind("keydown", r(this, "keydown")).bind("keyup", r(this, "keyup")),
            _r_()
        }
    }),
    _r_()
...
B.define("component/tooltip-loc", function(e, t, i) {
    ...
    i.exports = n.extend({
        ...
        _buildOptions: function() {
            ...
            this.options.target && (this.options.target = r(this.options.target).first()),
            this.options.content || (this.options.content = this.options.title || this.el.title),
            _r_()
        },
        ...
        _attachContent: function() {
            ...
            this.options.target ? e.append(this.options.target.clone()) : (this.options.target = [],
        ...
        _defineAlignmentVars: function() {
            ...
            this.options.placement.match(/top|bottom/) && (this.position = "top",
        ...
        _placeTooltip: function() {
            ...
            var e = this._accountForRTL(this.position)
              , t = this.dimension;
            this._accountForRTL(this.options.placement) === e ? this[e] = this.elOffset[e] - this.$tip[t]() : this[e] = this.elOffset[e] + this.$el[t](),
            _r_()
        },
        _alignTooltip: function() {
            var e, t;
            switch (_i_("4ab:d3b34b71"),
            "left" === this.position ? (e = "top",
            t = "outerHeight") : (e = "left",
            t = "outerWidth"),
        ...
        _attachEvents: function() {
            if (_i_("4ab:f9224418"),
            this.options.trigger.match(/manual/))
                return _r_();
            var e, t, i, n = this.options.trigger.split(" "), a = n.length, s = this.$el.add(this.$tip);
            for (this.options.intangible && (s = this.$el); a--; )
                "click" === (e = n[a]) ? this.$el.on("click", r.proxy(this.toggle, this)) : (t = "hover" == e ? "mouseenter" : "focusin",
...
B.define("component/search/destination/input", function(e, t, i) {
        ...
        return _r_(function(c) {
            ...
            return e = function(e) {
                ...
                u.MD(b[1])) {
                    ...
                    u.MN("index", 0),
                    e += p[2],
                    u.MN(b[0], u.F.entities(u.MI(u.array_length(u.MB(b[1]))) - u.MI(1))),
                    e += p[2];
                    var t = u.MC(b[1]) || [];
                    c.unshift(null);
                    for (var i = 1, n = t.length; i <= n; i++) {
                        ...
                        u.MD(b[3]) && (e += [u.F.entities(u.MC(b[3])), p[7]].join("")),
                        e += p[8],
                        ...
                        u.MD(b[6]) && (e += p[15]),
                        u.MJ(/zh|xt|ja|ko/.test(u.MB(b[2]))) && (e += p[6]),
                        u.MJ(u.MB(b[7]) + "" == "airport") ? e += p[16] : u.MJ(u.MB(b[7]) + "" == "city") ? e += p[17] : u.MJ(u.MB(b[7]) + "" == "country") ? e += p[18] : u.MJ(u.MB(b[7]) + "" == "district") ? e += p[19] : u.MJ(u.MB(b[7]) + "" == "hotel") ? e += p[20] : u.MJ(u.MB(b[7]) + "" == "landmark") ? e += p[21] : u.MJ(u.MB(b[7]) + "" == "region") ? e += p[22] : u.MJ(u.MB(b[7]) + "" == "theme") ? e += p[23] : e += p[18],
                        u.MD(b[5]) && (e += p[24]),
                        u.MJ(u.MB(b[8])) && u.MJ(u.MB(b[9])) && (e += p[25]),
                        u.MJ(u.MB(b[10])) && u.MJ(u.MC(b[10]).is_region_city) && (e += p[26]),
                        u.MJ(u.MB(b[7]) + "" == "theme") && (e += p[27],
                        u.MD(b[11]) || (e += p[28],
                        u.MN(b[11], p[29])),
                        e += p[30]),
                        u.MJ(u.MB(b[10])) && u.MJ(u.MC(b[10]).tabbed) && (e += p[31]),
                        (u.MK(u.MB(b[12])) || u.MJ(1 == u.array_length(u.MB(b[12])))) && (e += p[32]),
                        e += [p[33], u.MC(b[13]), p[34], u.F.entities(u.MC(b[14])), p[35]].join(""),
                        u.MD(b[15]) && (e += [p[36], u.F.html(u.MC(b[15])), p[35]].join("")),
                        e += p[37],
                        u.MJ(u.MB(b[7]) + "" == "recent-search") && u.MJ(u.MB(b[16])) && (e += [p[38], u.F.entities((u.MC(b[16]) || {}).b_url), p[39]].join("")),
                        e += p[40],
                        e += p[41],
                        u.MD(b[6]) ? (e += p[41],
                        u.MJ(u.MB(b[7]) + "" == "hotel") ? e += [p[42], (c.unshift({
                            color: "#6B6B6B",
                            height: p[43],
                            name: p[44],
                            width: p[43]
                        ...
                        f = u.HELPER("icon", c[0]),
                        c.shift(),
                        f), p[45]].join("") : u.MJ(u.MC(b[10]).ski_item) && u.MJ(u.MB(b[7]) + "" == "landmark") ? (e += p[42],
                        u.MD(b[17]) ? e += [p[41], (c.unshift({
                            color: "#6B6B6B",
                            height: p[43],
                            name: p[46],
                            width: p[43]
                        ...
                        c.shift(),
                        f), p[41]].join(""),
                        e += p[45]) : u.MJ(u.MB(b[7]) + "" == "landmark") ? e += [p[42], (c.unshift({
                            color: "#6B6B6B",
                            height: p[43],
                            name: p[48],
                            width: p[43]
                        ...
                        f = u.HELPER("icon", c[0]),
                        c.shift(),
                        f), p[45]].join("") : u.MJ(u.MB(b[7]) + "" == "airport") ? e += [p[42], (c.unshift({
                            color: "#6B6B6B",
                            height: p[43],
                            name: p[49],
                            width: p[43]
                        ...
                        f = u.HELPER("icon", c[0]),
                        c.shift(),
                        f), p[45]].join("") : u.MJ(u.MB(b[7]) + "" == "recent-search") ? e += [p[42], (c.unshift({
                            color: "#6B6B6B",
                            height: p[43],
                            name: p[50],
                            width: p[43]
                        ...
                        c.shift(),
                        f), p[45]].join("")) : (e += p[41],
                        u.MJ(u.MG((u.MC(b[10]) || {}).ski_item_replace_image)) ? e += [p[52], u.F.html(u.MC(b[15])), p[53], u.STATIC_HOSTNAME("/static/img/ski/ski.png", 0, 0, 0, 0), p[54]].join("") : u.MD(b[18]) ? e += [p[52], u.F.html(u.MC(b[15])), p[53], u.STATIC_HOSTNAME(u.MB(b[18]), 0, 0, 0, 0), p[54]].join("") : (e += p[41],
                        ...
                        u.MJ(u.MB(b[7]) + "" == "theme"))
                            ...
                            if (a += p[41],
                            u.MJ(u.MC(b[10]).popular) && (a += [p[62], u.F.entities(u.ME(p[63], u.MB, u.MN, null)), p[45]].join("")),
                            a += p[41],
                            u.MN(b[20], a),
                            e += p[41],
                            u.MJ(u.MB(b[22])) && u.MJ(u.MB(b[19])) && (e += [p[64], u.MC(b[22]), p[45]].join("")),
                            e += p[41],
                            u.MJ(u.MB(b[12])) && u.MJ(u.MB(b[29]))) {
                                ...
                                n = t.length; i <= n; i++)
                                    ...
                                    a += p[41],
                                    u.MJ(1 == i) ? (a += [p[65], u.F.entities((d || {}).text), p[41]].join(""),
                                    u.MJ(u.MG((d || {}).match)) && (a += [p[66], u.F.entities((d || {}).match), p[67]].join("")),
                                    a += p[41],
                                    u.MJ(u.MB(b[24])) && (a += p[68],
                                    u.MD(b[25]) ? a += [p[69], u.MC(b[24]), p[45]].join("") : a += [p[41], u.MC(b[24]), p[41]].join(""),
                                    a += p[41]),
                                    a += [p[45], u.MC(b[20]), p[70]].join("")) : u.MK(u.MJ(d.type + "" == "state")) && (a += p[41],
                                    u.MJ(2 < i) && (a += p[71]),
                                    a += p[41],
                                    u.MJ(u.MB(b[7]) + "" == "recent-search") && u.MJ(u.MB(b[16])) ? (a += p[72],
                                    u.MJ(u.MC(b[16]).b_checkin) && u.MJ(u.MC(b[16]).b_checkout) && (a += p[41],
                                    u.MD(b[26]) ? a += [p[41], u.DATE(u.MC(b[16]).b_checkin, "numeric_date_range", "", "", u.MC(b[16]).b_checkout), p[41]].join("") : a += [p[41], u.DATE(u.MC(b[16]).b_checkin, "short_date_without_year", "", "", ""), p[41], u.ME(p[73], u.MB, u.MN, null), p[41], u.DATE(u.MC(b[16]).b_checkout, "short_date_without_year", "", "", ""), p[41]].join(""),
                                    a += [p[41], u.ME(p[74], u.MB, u.MN, null), p[41]].join("")),
                                    a += p[41],
                                    u.MN("fe_occupancy", u.MI(u.MC(b[16]).b_total_adults) + u.MI(u.MC(b[16]).b_total_children)),
                                    a += [p[41], (c.unshift({
                                        num_people: u.MB(b[27])
                                    }),
                                    f = u.ME(p[75], u.MB, u.MN, u.MO(u.MC(b[27]), null, p[75])),
                                    c.shift(),
                                    f), p[76]].join("")) : a += [p[41], u.F.entities((d || {}).text), p[41]].join(""),
                                    a += p[41]),
                                    a += p[41];
                                c.shift(),
                                i = r,
                                ...
                                d = h,
                                a += p[41],
                                u.MD(b[28]) && (a += [p[77], u.MC(b[28]), p[45]].join("")),
                                a += p[41],
                                u.MN(b[23], a),
                                e += p[41]
                            } else {
                                ...
                                u.MD(b[30])) {
                                    ...
                                    n = t.length; i <= n; i++)
                                        ...
                                        a += p[41],
                                        u.MD(b[31]) && (a += p[78]),
                                        a += [p[41], u.F.entities(u.MC(b[32])), p[41]].join(""),
                                        u.MD(b[31]) && (a += p[45]),
                                        a += p[41];
                                    c.shift(),
                                    i = r,
                                    ...
                                    u.MD(b[33]) ? a += [p[41], u.MC(b[33]), p[41]].join("") : u.MD(b[15]) && (a += [p[41], u.F.entities(u.MC(b[15])), p[41]].join(""));
                                a += p[41],
                                u.MD(b[28]) && (a += [p[77], u.F.entities(u.MC(b[28])), p[45]].join("")),
                                a += p[41],
                                u.MN(b[23], a),
                                e += p[41]
                            }
                            e += [p[79], u.MC(b[23]), p[45]].join(""),
                            u.MJ(u.MB(b[12])) && u.MJ(u.MB(b[29])) || (e += [p[41], u.MC(b[20]), p[41]].join("")),
                            e += p[41]
                        }
                        e += p[41],
                        ...
                        e += p[41],
                        e += p[80],
                        u.MJ(u.MB(b[7]) + "" == "recent-search") && u.MJ(u.MB(b[16])) && (e += p[81]),
                        e += p[82]
                    }
                    c.shift(),
                    e += p[83],
    ...
    i.exports = s.extend({
        init: function() {
            ...
            this.$searchbox.length ? this.$skiInput = this.$searchbox.find('input[name="is_ski_area"]') : this.$skiInput = a('form#frm input[name="is_ski_area"]'),
            this.$skiInput.length || (this.$el.after('<input type="hidden" name="is_ski_area" value="0">'),
            ...
            this.destinationModel = this.options.isOrigin ? this.model.origin : this.model.destination,
            this.options.isOrigin && this.destinationModel.configure({
                groupName: "origin"
            }),
            ...
            this.options.focusOnTyping && this.options.isSticky && (this.stickyController = e("search/searchbox/searchbox-sticky-controller").getController()),
            this.options.focusOnTyping && this.enableFocusOnTyping(),
            this.$errors.filter(".-visible").length && (this.destinationModel.valid = !1),
            this.templateResults = B.jstmpl("search_destination_autocomplete_results"),
            this.toggleClear(),
            this.modelInit(),
            this.renderLoadingElement(),
            window.history && window.history.replaceState && -1 !== window.location.href.indexOf("errorc_searchstring_not_found=ss") && window.history.replaceState(null, document.title, window.location.href.replace("errorc_searchstring_not_found=ss", "")),
            _r_()
        },
        addInputEventListeners: function() {
            _i_("4ab:24e521ff"),
            s.prototype.addInputEventListeners.apply(this, arguments),
            this.$clear.length && this.$clear.on("click", this.clearClick.bind(this)),
            _r_()
        },
        renderLoadingElement: function() {
            _i_("4ab:cc2eea09"),
            this.shouldShowLoadingState = !0;
            this.$loading = a(B.jstmpl("search_destination_autocomplete_loading").render({})),
        ...
        showLoading: function() {
            _i_("4ab:96c0c99b"),
            this.shouldShowLoadingState && (s.prototype.listHide.apply(this),
        ...
        modelInit: function() {
            ...
            this.destinationModel.init(e),
            _r_()
        },
        modelChange: function(e) {
            if (_i_("4ab:b5cbe522"),
            e && e.group && e.group == this.groupName) {
                var t = this.destinationModel.get();
                t.ss == this.input.value || this.isDeletion || (t.ss_modified && B.env.fe_s_prprtyt ? this.setValue(t.ss_modified) : this.setValue(t.ss)),
                e.onlyCurrentCountry && (this.$input.focus(),
                this.autocomplete()),
        ...
        modelValidation: function(e) {
            _i_("4ab:c7ade742"),
            e && e.group == this.groupName && (this.$errors.filter(".-visible").removeClass("-visible"),
            this.destinationModel.valid || (this.$el.find("#destination__error").addClass("-visible"),
            this.$errors.filter('[data-error-id="' + this.destinationModel.validationError + '"]').addClass("-visible"),
            r.send("[error] destination: " + this.destinationModel.validationError))),
            _r_()
        },
        inputClick: function() {
            _i_("4ab:956c29e8"),
            ("" === this.input.value || this.inputUntouched) && this.model.getFlag("with_recent_search") ? this.showRecentSearchSuggestions() : ("" === this.input.value || this.inputUntouched) && this.model.getFlag("on_click_suggestions") ? this.showSuggestions() : "" === this.input.value && (this.model.getFlag("with_popular_nearby_suggestions") || this.model.getFlag("sr_with_popular_destinations_suggestions")) && this.showPopularNearbySuggestions(),
            s.prototype.inputClick.apply(this, arguments),
            _r_()
        },
        inputInput: function() {
            _i_("4ab:3ce47b6a"),
            this.isVisibleCalendar() && this.hideCalendar();
            var e = this.input.value;
        ...
        inputBlur: function() {
            ...
            0 === this.input.value.length && this.model.getFlag("clear_input_on_click") && this.input.value !== this.$input.data("cached-value") && (this.input.value = this.$input.data("cached-value") || ""),
            this.metaMatchesOptionIsActive && this.metaMatchesOptionValue && this.setValue(this.metaMatchesOptionValue),
            s.prototype.inputBlur.apply(this, arguments),
            this.suggestionsLocked = !1,
            _r_()
        },
        inputFocus: function() {
            return _i_("4ab:e2028d97"),
            this.metaMatchesOptionIsActive && (this.metaMatchesOptionValue = this.input.value,
        ...
        onAutocompleteSearchStart: function() {
            _i_("4ab:93941720"),
            o.emit(o.SEARCHBOX_AUTOCOMPLETE_TRIGGERED),
            _r_()
        },
        clearClick: function(e) {
            ...
            this.input.focus(),
            this.model.getFlag("with_recent_search") && this.showRecentSearchSuggestions(),
            _r_()
        },
        setValue: function(e) {
            _i_("4ab:121e7d07"),
        ...
        listShow: function() {
            ...
            this.results && this.results.filter(function(e) {
                return _i_("4ab:13bfde30"),
                _r_(e.photo_uri || e.isPopularNearby || e.isRecentSearch)
            }).length ? this.$list.addClass("sb-autocomplete__list-with_photos") : this.$list.removeClass("sb-autocomplete__list-with_photos"),
            0 < this.items.length && this.input.value.length >= this.options.minLength ? s.prototype.listShow.apply(this, arguments) : 0 < this.items.length && (this.model.getFlag("on_click_suggestions") || this.model.getFlag("with_recent_search") || this.model.getFlag("with_popular_nearby_suggestions") || this.model.getFlag("sr_with_popular_destinations_suggestions")) && s.prototype.listShow.apply(this, arguments),
            _r_()
        },
        autocomplete: function(e) {
            ...
            this.hideLoading(),
            this.toggleClear(),
            e.fromFocus || (this.isDeletion ? this.destinationModel.reset() : this.postAutocomplete(),
            this.input.value.length >= this.options.minLength && (this._loading = !0),
            this.timer = setTimeout(function() {
                _i_("4ab:a9af8f9c"),
                this.input.value.length >= this.options.minLength && (this.showLoading(),
                this.destinationModel.getPredictions(this.query(), this.render.bind(this)),
        ...
        query: function() {
            return _i_("4ab:2a33cf36"),
            _r_(this.input.value)
        },
        extendOptions: function() {
            return _i_("4ab:306d554b"),
            _r_({})
        },
        render: function(e, t) {
            _i_("4ab:a6930317"),
            ...
            this.hideLoading(),
            !e && this.model.getFlag("on_click_suggestions_track") && t.on_click_suggestion && (this.on_click_suggestion = !0),
            this._loading = !1,
            !e || "service-booking-no-results" != e.toString() && -1 === e.toString().indexOf("ZERO_RESULTS") || r.send("[context] autocomplete zero results search"),
            !e && Array.isArray(t.results) ? (r.send("[context] autocomplete suggestions [" + t.results.length + "]"),
            t.is_powered_by_google && r.send("[context] autocomplete google place search"),
            B.env.fe_s_prprtyt && t.results.map(function(e) {
                _i_("4ab:69cfb297");
                var t = e.meta_matches;
                if (t && 0 < t.length) {
                    var i = !1;
                    e.property_in_label = e.meta_matches.map(function(e) {
                        return _i_("4ab:3cab0d47"),
                ...
                e.flags && "landmark" === e.dest_type && e.flags.ski_item && !e.property_in_label && (e.fe_valueWithoutPropertyType = !0,
                e.property_in_label = B.jstmpl.translations("ski_autocomplete_ski_resort"),
                e.property_in_id = e.id),
                _r_()
            }),
            this.results = t.results,
            B.env.rtl && (t.is_rtl = !0),
            this.model.getFlag("region_second_line") && (t.fe_items_are_multiline = !0),
            this.model.getFlag("icon_revamp") && (t.fe_icon_revamp = !0),
            B.env.fe_sb_use_new_ski_icon && (t.fe_sb_use_new_ski_icon = !0),
            this.options.collapseACSingleAirport && 2 == t.results.length && "city" === t.results[0].dest_type && "airport" === t.results[1].dest_type && t.results[1].flags && t.results[1].flags.tabbed && (t.results[1].flags.tabbed = 0,
            t.results.shift()),
            this.items = t.results.filter(function(e) {
                return _i_("4ab:ac61c77f"),
                _r_(!!e.label)
            }).map(function(e) {
                if (_i_("4ab:36887c13"),
                e.property_in_label && !e.fe_valueWithoutPropertyType && B.env.fe_s_prprtyt) {
                    var t = "";
            ...
            this.model.getFlag("a11yinput") && this.a11yAnnounceResults(t)) : e || (this.$list.html(this.templateResults.render(t)),
            ...
            setTimeout(function() {
                ...
                this.$items.each(function() {
                    _i_("4ab:00324166"),
                    this.scrollWidth > this.offsetWidth && this.setAttribute("data-title", this.getAttribute("data-label")),
                    _r_()
                }),
                _r_()
            }
        ...
        a11yAnnounceResults: function(e) {
            if (_i_("4ab:ed896d16"),
            Array.isArray(e.results) && 0 < e.results.length && !this.isA11yMessageReading) {
                this.isA11yMessageReading = !0;
                var t = setTimeout(function() {
                    _i_("4ab:f93d45a5"),
                    this.$el.find(".sb-a11y-announcement").show(),
                    this.$el.find(".sb-a11y-announcement").html("<p>" + B.jstmpl.translations("a11y_index_autocomplete_suggested_destinations") + "</p>"),
                    setTimeout(function() {
                        _i_("4ab:444f6be7"),
        ...
        choose: function(e) {
            ...
            r.send("[interaction] autocomplete click [" + this.results[e].dest_type + "]"),
            clearTimeout(this.timer),
            this.destinationModel.abortPredictions();
            ...
            B.env.fe_s_prprtyt && (a(".property_in_filter").remove(),
            i.property_in_id && a("form.sb-searchbox").append('<input class="property_in_filter" type="hidden" name="order_ht_id" value="' + i.property_in_id + '">')),
            i.flags && i.flags.deals && this.$el.after("<input type='hidden' name='em_ac_deal_option_clicked' value='1'>"),
            this.$skiInput && this.$skiInput.length && this.$skiInput.val(i.flags && i.flags.ski_item),
            ...
            if (-1 !== ["landmark", "airport", "district"].indexOf(i.dest_type)) {
                ...
                this.model.getFlag("open_location_in_map_checkbox") && a(".sb-searchbox__map_trigger input").prop("checked", "checked"),
                a(".sb-searchbox__map_trigger").removeClass("g-hidden"),
                this.destinationModel.setTrackingFields("map_trigger", n))
            } else
                (this.model.getFlag("open_location_in_map") || this.model.getFlag("open_location_in_map_checkbox")) && (a(".sb-searchbox__map_trigger").addClass("g-hidden"),
                this.model.getFlag("open_location_in_map_checkbox") && a(".sb-searchbox__map_trigger input").prop("checked", null),
                this.destinationModel.setTrackingFields("map_trigger", []));
            this.model.getFlag("can_show_sb_entire_place_checkbox") && (i.b_show_entire_homes_checkbox ? a(".js-sb-entire-place-checkbox").removeClass("g-hidden") : a(".js-sb-entire-place-checkbox").addClass("g-hidden").find('input[name="sb_entire_place"]').prop("checked", !1).removeAttr("checked")),
            "theme" != this.results[e].dest_type && "theme_dest" != this.results[e].result_type || this.model.submit(),
            o.emit(o.SEARCHBOX_DESTINATION_SELECTED, {
                destination: i
            }),
        ...
        showCalendarOnDesinationChange: function() {
            if (_i_("4ab:b4b21470"),
            !this.model.getFlag("calendar_on_destination_change") || this.model.dates.get().checkin)
                return _r_();
            this.showCalendar(),
            _r_()
        },
        ...
        clickOut: function() {
            _i_("4ab:3f94e649"),
            s.prototype.clickOut.apply(this, arguments),
            _r_()
        }
    }),
    _r_()
...
B.define("search/destination/model", function(e, t, i) {
    ...
    $.extend(r.prototype, {
        init: function(e) {
            ...
            s.b_ac_search_history && this.model.getFlag("on_click_suggestions") && (t.searchHistory = !0),
            this.model.use("group"),
            this.model.on("init", function(e) {
                _i_("4ab:46d69989"),
                "group" === e.group && this.fetchSuggestions(t),
                _r_()
            }
            .bind(this))),
            this.model && this.model.getFlag && this.model.getFlag("with_recent_search") && (this.model.use("recentSearch"),
            this.suggestionsCache && this.suggestionsCache.results && this.suggestionsCache.results.length || (this.suggestionsCache = {
                results: this.model.recentSearch.getRecentSearchSuggestions()
            })),
        ...
        configure: function(e, t) {
            _i_("4ab:66d50a77"),
            void 0 !== t ? this.options[e] = t : "object" == typeof e && $.extend(this.options, e),
            _r_()
        },
        getOption: function(e) {
            return _i_("4ab:07c3d404"),
            _r_(this.options[e])
        },
        get: function() {
            return _i_("4ab:867e130f"),
            _r_(this.data)
        },
        set: function(i) {
            if (_i_("4ab:5c9c4913"),
            a.isLocalStorageSupported() && i.dest_id && i.dest_id !== a.getSessionValue("prev_destination_id")) {
                var e = JSON.stringify(i);
                a.addSessionValue("prev_destination_id", i.dest_id, !1),
                a.addSessionValue("prev_destination_data", e, !1)
            }
            if (this.ac.selected = !0,
            this.searchInstance && this.searchInstance.getResultDetails && !i._details)
                return this.searchInstance.getResultDetails(i, function(e, t) {
                    _i_("4ab:871dc490"),
                    (t = t || {})._details = !0,
                    this.set(t),
                    window.ga && window.ga("send", "event", "ac_google_places", [i.place_types || "unknown", i.name].join("|"), this.data.ss_raw, i.position),
                    _r_()
                }
                .bind(this)),
                _r_();
            ...
            i.property_in_label && B.env.fe_s_prprtyt && (i.isMetaMatchesItem && i.labels && i.labels[0] ? this.data.ss_modified = i.labels[0].text + " • " + i.property_in_label : this.data.ss_modified = B.jstmpl.translations("ss_search_box_search_property_type", null, {
            ...
            i.place_id && i.latitude && i.longitude ? (this.data.place_id = i.place_id,
            this.data.latitude = i.latitude,
            this.data.longitude = i.longitude,
            this.data.place_types = i.place_types) : (i.dest_id && i.latitude && i.longitude ? (this.data.place_id = "",
            this.data.latitude = i.latitude,
            this.data.longitude = i.longitude) : (this.data.place_id = "",
            this.data.latitude = "",
            this.data.longitude = ""),
            this.data.place_types = null),
            i._fa && this.model.setFormAction(i._fa),
            i._ef = i._ef || [],
            this.data.dest_id && i._ef.push({
                name: "dest_id",
            ...
            "rentalcars" === i.type && (this.data.type = "rentalcars",
            this.data.placeKey = i.placeKey,
            this.data.rentalcarsItem = i,
            "origin" === this.options.groupName ? this.model.setFields("rentalcars", i.fields.puFields) : this.model.setFields("rentalcarsDrop", i.fields.doFields)),
            i.region_type && i._ef.push({
                name: "region_type",
                value: i.region_type
            }),
        ...
        setSearchString: function(e) {
            ...
            this.data.ss = e,
            this.data.ss_raw = e,
            "rentalcars" === this.model.getMode() || this.valid || this.validate(),
            _r_()
        },
        reset: function() {
            _i_("4ab:025738e6"),
            ...
            "rentalcars" == this.data.type && (this.ac.selected = !1,
            this.data.type = null,
            this.data.placeKey = null,
            this.data.rentalcarsItem = null,
            "origin" == this.options.groupName ? this.model.setFields("rentalcars", []) : this.model.setFields("rentalcarsDrop", [])),
            this.emit("change"),
            _r_()
        },
        ...
        validate: function() {
            ...
            if (!this.options.validate)
                ...
                _r_(e);
            return "rentalcars" === this.model.getMode() ? (this.ac.selected && "" !== this.data.ss || (e = !1,
            t = "search-string-empty"),
            e && this.valid === e || (this.valid = e,
            this.validationError = t,
            this.emit("validation"))) : ("" === this.data.ss && (e = !1,
            t = "search-string-empty"),
            this.valid !== e && (this.valid = e,
            this.validationError = t,
        ...
        initPredictions: function() {
            (_i_("4ab:755389c7"),
            this.options.gpf) && B.require("search/destination/service-atlas").init();
            _r_()
        },
        configurePredictions: function(e) {
            _i_("4ab:2393882a"),
            $.extend(this.predicitonParameters, e),
            _r_()
        },
        getPredictions: function(e, a) {
            ...
            this.options.onlyCurrentCountry && (t.e_acf_i = s.b_country_id,
            t.e_acf_t = "country"),
            "rentalcars" == this.model.getMode() && (t.bgo = 1),
            this.searchInstance = n.search(t, function(e, i) {
                _i_("4ab:090c5577");
                var n = arguments;
                if (i) {
                    if (this.model.setFields(this.options.groupName, i._ef),
                    this.model.setFields("destinationNotSelected", i._efd),
                    this.searchInstance && this.searchInstance.getResultDetails && i.results && i.results[0] && !i.results[0]._details)
                        return this.searchInstance.getResultDetails(i.results[0], function(e, t) {
                            _i_("4ab:6b74c459"),
                            e || (this.ac.dataset = i.results,
                            this.ac.dataset[0] = t,
        ...
        getSuggestions: function(e, t) {
            ...
            this.model.one("destination:suggestions", function() {
                _i_("4ab:19d47861"),
                this.suggestionsCache.results.length && e(null, this.suggestionsCache),
                _r_()
            }
            .bind(this)),
            _r_()
            ...
            this.suggestionsInstance = t.getSuggestions(function(e, t) {
                ...
                !e && t && t.results) {
                    ...
                    for (var i = 0; i < t.results.length; i++)
                        !t.results[i].ss && t.results[i].label && (t.results[i].ss = t.results[i].label);
        ...
        getOnlyCurrentCountry: function() {
            return _i_("4ab:784bf933"),
            _r_(!!this.options.onlyCurrentCountry)
        },
...
B.define("search/destination/service", function(i, e, t) {
    ...
    function s(e, t, a) {
        ...
        var d = function(e, t, i) {
            if (_i_("4ab:bd577c95"),
            l++,
            r.length && (t ? o.push(t) : _[e] = i,
            l == r.length))
                if (o.length == r.length)
                    a.call(null, o[0], null),
                    B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_address_search_failed", 1);
                else {
                    var n = function(e, i, t, n) {
                        ...
                        return e.forEach(function(t) {
                            ...
                            ["_ef", "_efd"].forEach(function(e) {
                                _i_("4ab:dbb8c68e"),
                                t[e] && (r[e] = r[e].concat(t[e].filter(function(e) {
                                    _i_("4ab:fb404d6b");
                                    var t = {};
                                    ...
                                    _r_(function(e) {
                                        return _i_("4ab:f2b14173"),
                                        _r_(!t[e.name])
                                    })
                                }(r[e])))),
                                _r_()
                            }),
                            r.is_powered_by_google = r.is_powered_by_google || t.results.length && t.is_powered_by_google,
                            _r_()
                        }),
                    ...
                    a.call(null, null, n),
                    B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_address_search_succeeded", 1)
                }
            _r_()
        };
        for (i = 0; i < e.length; i++)
            (n = e[i].search.call(e[i], $.extend({}, t), d.bind(null, i))).getResultDetails && (s = n.getResultDetails),
            r.push(n);
        return _r_({
            abort: function() {
                for (_i_("4ab:ff00001c"),
                i = 0; i < r.length; i++)
                    r[i].abort();
                _r_()
            },
    ...
    function h(e) {
        return _i_("4ab:05edf08f"),
        _r_(-1 != ["route", "postal_code", "street_address"].indexOf(e.place_type))
    }
    function r(e, t, i) {
        var n;
        _i_("4ab:d5d9fff2");
    ...
    t.exports = {
        search: function(e, t) {
            ...
            if (/^[,\s]+$/.test(e.ss))
                return t(new Error("Invalid search string"), null),
                _r_();
                ...
                var a = []
                  ...
                  , r = function(e, t) {
                    ...
                    a.length)
                        if (e)
                            s.push(e),
                            s.length == a.length && i.call(null, e, t);
                        else
                            for (i.call(null, e, t),
                            n = 0; n < a.length; n++)
                                a[n].abort();
...
B.define("search/destination/service-atlas", function(e, t, i) {
    ...
    function u(n, e, t) {
            ...
            var i = {
                ...
                label_highlighted: function(e, t, i) {
                    ...
                    for (var a = t.map(function(e) {
                        return _i_("4ab:3513ad06"),
                        _r_(e.offset)
                    }), s = t.map(function(e) {
                        return _i_("4ab:5c09a709"),
                        _r_(e.offset + e.length - 1)
                    }), r = 0; r < e.length; r++)
                        -1 != a.indexOf(r) && (n += "<b>"),
                        n += e.charAt(r),
                        -1 != s.indexOf(r) && (n += "</b>");
        ...
        window.google && (i.is_powered_by_google = 0 < i.results.length,
    ...
    i.exports = n.extend({
        init: function(e, n) {
            ...
            var a = this;
            if (!c())
                throw "service-atlas: B.atlas is not available";
            if (this.initialized)
                return n && this.atlas && this.atlas.done(n),
                _r_();
            this.initialized = !0;
            B.require(["async-loader"], function(e) {
                ...
                e.load({
                    ...
                    function(e) {
                        ...
                        s.b_enable_mapbox_fallback && (i = d ? "provider-mapbox-places" : "provider-google-places"),
                        a.atlas = new e({
                            provider: i,
        ...
        search: function(t, i) {
            ...
            var a = function(e) {
                _i_("4ab:bbd056dd"),
                n || (e && Array.isArray(e) ? u(t, e, i) : i(new Error("service-atlas-invalid-results"), null)),
                _r_()
            }
              , s = function(e) {
                _i_("4ab:ac1377c8"),
...
B.define("search/destination/service-booking", function(e, t, i) {
    ...
    function o(n, e, t) {
        _i_("4ab:8055be59"),
        n && n.city ? n.__upa__ || 0 !== n.city.length || n.bbtoollocations && 0 !== n.bbtoollocations.length || n.theme && 0 !== n.theme.length || n.searches && 0 !== n.searches.length ? (n.city = n.city.map(function(e, t) {
            var i;
            return _i_("4ab:2ca133ad"),
            !e.label && e.labels && (e.label = (i = e.labels,
            _i_("4ab:18745e16"),
            _r_(i.map(function(e) {
                return _i_("4ab:ec1c0c2e"),
                _r_(e.text)
            }).join(", ")))),
            !e.labels || "zh" !== e.lc && "xt" !== e.lc && "ja" !== e.lc && "ko" !== e.lc || (e.label_blocks = function(e) {
                _i_("4ab:dad77360");
                var i = [];
        ...
        n.results = n.city,
        n.bbtoollocations && (n.results = n.bbtoollocations.map(function(e, t) {
            return _i_("4ab:52311848"),
            e.name = B.jstmpl.fn.FILTERS.html(e.name),
            e.address = B.jstmpl.fn.FILTERS.html(e.address),
            void 0 !== e.label && (e.label = B.jstmpl.fn.FILTERS.html(e.label)),
            void 0 !== e.label_highlighted && (e.label_highlighted = B.jstmpl.fn.FILTERS.html(e.label_highlighted)),
            e.label_blocks = [{
                highlighted: 1,
                text: e.name
            }, {
        ...
        n.theme && (n.theme = n.theme.map(function(e, t) {
            return _i_("4ab:bda296e8"),
            e.ss = e.label,
            e._ef = e._ef || [],
            e._ef.push({
                name: "ac_position",
        ...
        n._efd = n._efd || [],
        t(null, n),
        B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_brick_search_succeeded", 1)) : (B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_brick_search_failed", 1),
        t(new Error("service-booking-no-results"), n)) : (B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_brick_search_failed", 1),
    ...
    i.exports = n.extend({
        search: function(n, a) {
            ...
            B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_brick_search_started", 1);
            var i = $.ajax({
                type: r,
                url: s,
                data: t,
                        ...
                        "error" === t && 403 === e.status) {
                            ...
                            if (n.indexOf("page_reload") < 0) {
                                ...
                                var s = B.jstmpl.translations("search_sbox_abandoned_search_open_tab_message")
                                  , r = B.jstmpl.translations("search_sbox_abandoned_search_open_tab_message_refresh_cta");
                                -1 < n.indexOf("#") ? ($("body").append($("<div class='sb-lightbox-brick-error'><p>" + s + "<br><br><a class='btn btn-primary'>" + r + "</a></p></div>").on("click", "a", function() {
                                    _i_("4ab:f47fa620"),
                                ...
                                setTimeout(function() {
                                    ...
                                    window.location.reload(!0),
                                    _r_()
                                }, a)) : (-1 < n.indexOf("?") ? n += "&page_reload=1" : n += "?page_reload=1",
                                $("body").append($("<div class='sb-lightbox-brick-error'><p>" + s + "<br><br><a class='btn btn-primary' href='" + n + "'>" + r + "</a></p></div>")),
                                setTimeout(function() {
                                    _i_("4ab:56a1f835"),
        ...
        getSuggestions: function(n, e) {
            ...
            if (e && e.searchHistory && B.env.b_ac_search_history)
                ...
                _r_();
            "searchresults" === B.env.b_action && (i = "valid" === (i = B.search.dates("checkin")).type ? i.toString() : ""),
            t = Object.assign({}, t, {
                ttype: 0,
                checkin: i
            });
            var a = $.ajax({
                ...
                error: function(e, t, i) {
                    ...
                    "abort" === t)
                        return _r_();
                    n(new Error("service-booking-error " + i), null),
                    _r_()
                }
            });
            return _r_({
        ...
        !function(e, n) {
            ...
            $.ajax({
                ...
                success: function(e, t) {
                    if (_i_("4ab:bd7fef72"),
                    e && e.data && e.data.googlePlaceDetails && e.data.googlePlaceDetails.results && e.data.googlePlaceDetails.results[0]) {
        ...
        search: function(e, s) {
            ...
            var i = $.ajax({
                ...
                success: function(e, t, i) {
                    ...
                    a = s,
                    _i_("4ab:9bbb7b1c"),
                    n && n.data && n.data.googlePlaces && n.data.googlePlaces.results && n.data.googlePlaces.results.length ? (a(null, {
                        results: n = n.data.googlePlaces.results.map(function(e) {
                            ...
                            return e.place && e.place.location && (t._details = !0,
                    ...
                    B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_carrier_search_succeeded", 1)) : (a(new Error("service-carrier-invalid-results"), null),
                    B.env.fe_m_sb_index_track_goals && B.et.goalWithValue("js_mobile_index_sb_carrier_search_failed", 1)),
                    _r_(),
                    _r_()
                }
                .bind(this),
...
B.define("component/search/travel-purpose/checkbox", function(e, t, i) {
    ...
    i.exports = n.extend({
        init: function() {
            ...
            this.$checkbox.length && "checked" === this.$checkbox[0].getAttribute("checked") && (this.searchedBusiness = !0),
            this.updateRedirectFormFieldsOnModelChange = !1,
            (this.searchedBusiness || this.profileSplitAccounts) && this.bindEvents(),
            _r_()
        },
        bindEvents: function() {
            _i_("4ab:94f4c6a6"),
            ...
            this.model.on("change", function(e) {
                _i_("4ab:48f1f1ce"),
                !this.updateRedirectFormFieldsOnModelChange || e && e.redirectFormFields || this.createRedirectFormFields(),
                _r_()
            }
            .bind(this)),
            _r_()
        ...
        handleCheckboxChange: function() {
            _i_("4ab:a853bf4c"),
            this.$checkbox.prop("checked") ? this.$hidden && (this.$hidden.remove(),
            this.$checkbox[0].setAttribute("name", "sb_travel_purpose")) : (this.$hidden = $('<input name="sb_travel_purpose" value="leisure" type="hidden" />').appendTo(this.$el),
        ...
        createRedirectFormFields: function() {
            if (_i_("4ab:9f95f63a"),
            !this.profileSplitAccounts || !this.profileSplitAccounts.length || !B.env.feature_profile_split_sb_checkbox)
                return _r_();
            ...
            -1 === t.indexOf(B.env.b_nonsecure_hostname) && (t = B.env.b_nonsecure_hostname + t),
            -1 === t.indexOf("?") ? t += +this.$form.serialize() : t += "&" + this.$form.serialize(),
            this.model.setFields("bnss", [{
                type: "hidden",
                name: "redirect_url",
                value: t
        ...
        findAccountType: function(e) {
            var t, i, n;
            for (_i_("4ab:4b27ed34"),
            t = 0,
            i = this.profileSplitAccounts.length; t < i; ++t)
                "business" === this.profileSplitAccounts[t].b_type && e ? n = this.profileSplitAccounts[t] : "business" === this.profileSplitAccounts[t].b_type || e || (n = this.profileSplitAccounts[t]);
            return _r_(n)
        }
    }),
    _r_()
...
B.define("component/search/dates/date-field", function(e, t, i) {
    ...
    i.exports = n.extend({
        init: function() {
            ...
            this.$inputYear = this.$inputs.filter('[data-input-fragment="year"]'),
            this.$inputMonth = this.$inputs.filter('[data-input-fragment="month"]'),
            ...
            B.eventEmitter.on("CALENDAR:shown CALENDAR:closed", this.updateFocusClass.bind(this)),
            this.previousState = {},
            this.state = {
                editing: !1,
                currentField: null
        ...
        checkDateFields: function() {
            var e, t;
            _i_("4ab:b79e53cf"),
            this.$inputYear.length && this.$inputMonth.length && this.$inputDay.length || (e = this.model.dates.getFallbackDates(this.options.modelMode),
            0 === this.$inputYear.length && (t = e.year || "",
            this.$inputYear = this.createDateInputField(this.options.modelMode + "_year", t).appendTo(this.el),
            setTimeout(function() {
                throw _i_("4ab:05cd2402"),
                Error("Date input field year was not found in " + B.env.b_action + " action")
            }, 0)),
            0 === this.$inputMonth.length && (t = e.month || "",
            this.$inputMonth = this.createDateInputField(this.options.modelMode + "_month", t).appendTo(this.el),
            setTimeout(function() {
                throw _i_("4ab:01a0e5f0"),
                Error("Date input field month was not found in " + B.env.b_action + " action")
            }, 0)),
            0 === this.$inputDay.length && (t = e.day || "",
            this.$inputDay = this.createDateInputField(this.options.modelMode + "_monthday", t).appendTo(this.el),
            setTimeout(function() {
                throw _i_("4ab:53fd85ba"),
                Error("Date input field day was not found in " + B.env.b_action + " action")
            }, 0))),
            _r_()
        },
        createDateInputField: function(e, t) {
            return _i_("4ab:b9c402e3"),
            _r_($("<input>").attr({
                type: "hidden",
                name: e,
                value: t
        ...
        initModel: function() {
            ...
            this.$field.hasClass("-empty") && "index" === B.env.b_action && this.render()) : e = this.model.dates.initDate(this.options.modelMode, null),
        ...
        inputFocus: function(e) {
            ...
            this.state.currentField = e.target.getAttribute("data-input-fragment"),
            this.startEditing(),
        ...
        inputFocusTrack: function() {
            _i_("4ab:7630c5c4"),
            r.trackEvent(r.SearchBoxTracker, "Keyboard Focus", this.options.modelMode + " field"),
            _r_()
        },
        inputBlur: function(e) {
            _i_("4ab:4a0c1d36");
            ...
            this.inputBlurPrevented || (this.state.editing = !1,
        ...
        inputKeyDown: function(e) {
            ...
            var t = e.target
              , i = t.getAttribute("data-input-fragment");
            if (a.isModifier(e.which))
                return _r_();
            a.isUpArrow(e.which) ? (this.adjustDateFragment(i, t.value, 1),
            e.preventDefault()) : a.isDownArrow(e.which) ? (this.adjustDateFragment(i, t.value, -1),
            e.preventDefault()) : a.isLeftArrow(e.which) || a.isBackspace(e.which) ? this.inputMoveAdjacent(e, -1, {
        ...
        inputMoveAdjacent: function(e, t, i) {
            _i_("4ab:e7adcbb3");
            var n, a, s = e.target, r = this.$inputs.length, o = h.getPosition(s), _ = 0, l = this.$inputs.filter(s).index(), d = r - 1;
            i = i || {};
            if (0 < t && (_ = s.value.length,
            d = 0),
            i.automatic && l == r - 1)
                return _r_();
            if (!i.force && h.getSelectionLength(s))
                return _r_();
            (i.force || o == _) && (((l += t) < 0 || r - 1 < l) && (l = d),
            n = this.$inputs.get(l),
            i.automatic && n.value.length ? n.select() : (a = 0 < t ? 0 : n.value.length,
            h.setPosition(n, a),
        ...
        inputKeyPress: function(e) {
            _i_("4ab:0c3eb8b9"),
            e.keyCode && a.isNavigation(e.keyCode) || !(e.which < 48 || 57 < e.which) || (this.inputMoveAdjacent(e, 1, {
                automatic: !0,
                force: !0
            }),
            e.preventDefault()),
        ...
        adjustDateFragment: function(e, t, i) {
            ...
            t = "" === t ? 0 : +t,
            "month" === e && (t -= 1),
            this.model.dates.adjustEditingFragment(this.options.modelMode, e, t, i),
            _r_()
        },
        apply: function() {
            _i_("4ab:5697e3f5"),
        ...
        updateFocusClass: function() {
            ...
            setTimeout(function() {
                ...
                t || i ? this.$el.addClass("-focus") : this.$el.removeClass("-focus"),
                _r_()
            }
            .bind(this), 100),
            _r_()
...
booking.jstmpl("search_dates_length_of_stay", function() {
    ...
    return _r_(function(e) {
        ...
        n.MJ(n.MB(r[3])) ? (t += s[2],
        n.MJ(n.MB(r[1]) + "" == "") && (t += s[3],
        n.MN("fe_sb_los_bold", n.MJ(n.MC(r[0]) + "" == "hotel") && n.track_experiment("AEJPOTIKSBOEQC")),
        t += s[4]),
        t += s[5],
        n.MD(r[1]) && (t += s[6]),
        t += s[7],
        n.MD(r[1]) && (t += s[8]),
        t += s[9],
        n.MD(r[2]) ? t += [s[10], (e.unshift({
            num_weeks: n.MB(r[2])
        }),
        a = n.ME(s[11], n.MB, n.MN, n.MO(n.MC(r[2]), null, s[11])),
        e.shift(),
        a), s[3]].join("") : n.MJ(n.MB(r[4])) || n.MJ(n.MC(r[5])) && n.MJ(n.MC(r[5]).b_children_total) ? t += [s[10], (e.unshift({
            num_nights: n.MB(r[3])
        }),
        a = n.ME(s[12], n.MB, n.MN, n.MO(n.MC(r[3]), null, s[12])),
        e.shift(),
        a), s[3]].join("") : t += [s[10], (e.unshift({
            num_nights: n.MB(r[3])
        }),
        a = n.ME(s[13], n.MB, n.MN, n.MO(n.MC(r[3]), null, s[13])),
        e.shift(),
        a), s[3]].join(""),
        t += s[14],
        n.MD(r[1]) && (t += s[15]),
...
B.define("component/search/dates/length-of-stay", function(e, t, i) {
    ...
    i.exports = a.extend({
        init: function() {
            ...
            this.model.on("change", this.modelChange.bind(this)),
            this.state = {},
            "hotel" === B.env.b_action && B.et.track("AEJPOTIKSBOEQC") && (this.state.fe_sb_los_bold = 1),
        ...
        render: function() {
            ...
            this.state.fe_is_family = t.children_ages && 0 < t.children_ages.length ? 1 : 0,
            this.state.fe_is_availability = this.options.isAvailability,
            this.state.fe_sb_state_length_of_stay = !e.editing && e.checkin && e.checkout && 0 < n.diff(e.checkout, e.checkin) ? n.interval(e.checkin, e.checkout) - 1 : "";
            var i = this.state.fe_sb_state_length_of_stay;
            this.state.fe_sb_state_length_of_stay_in_weeks = i && 7 <= i && !(i % 7) ? i / 7 : 0,
...
B.define("search/dates/model", function(e, t, i) {
    ...
    function d(e) {
        ...
        this._options.syncLegacy && (this.boundLegacyDateChange = this.legacyDateChange.bind(this),
        B.eventEmitter.on(B.Search.Events.DATE_CHANGED, this.boundLegacyDateChange)),
        _r_()
    }
    $.extend(d.prototype, {
        init: function(e) {
        ...
        configure: function(e, t) {
            ...
            void 0 !== t ? this._options[e] = t : "object" == typeof e && $.extend(this._options, e),
            i != this._options.maxMonths && (this._data.lastValidDay = l.createFlexible({
                year: this._data.firstValidDay.year,
                month: this._data.firstValidDay.month + this._options.maxMonths,
                day: 0
            })),
            n !== this._options.syncLegacy && B.eventEmitter[this._options.syncLegacy ? "on" : "off"](B.Search.Events.DATE_CHANGED, this.boundLegacyDateChange),
            _r_()
        },
        getOption: function(e) {
            return _i_("4ab:e91d2a9f"),
            _r_(this._options[e])
        },
        get: function() {
            return _i_("4ab:1a04a75e"),
            _r_(this._data)
        },
        getValidationError: function() {
            return _i_("4ab:9f837e6c"),
            _r_(this._validationError)
        },
        initDate: function(e, t, i) {
            ...
            if (this._data.initialized)
                return _r_(!1);
            return t && (n = this.setDate(e, t, i)),
            this._data[e + "Time"] = {
                hours: 10,
                minutes: 0
            },
            this["initialized" + e] = !0,
            this.initializedcheckin && this.initializedcheckout && (this.emit("init"),
            this._data.initialized = !0),
            _r_(n)
        },
        setDate: function(e, t, i) {
            ...
            if (t = l.create(t),
            !this._options.noValidation && !this.validateDate(e, t, {
                loose: !0
            }).valid)
                return _r_(!1);
            if ("checkin" == e)
                ...
                a = !0,
                l.compare(this._data.checkin, this._data.firstValidDay) < 0 && (this._data.checkin = l.create(this._data.firstValidDay)),
                0 < l.compare(this._data.checkin, this._data.lastValidDay) && (this._data.checkin = l.createFlexible({
                ...
                s = !0,
                0 < l.compare(this._data.checkout, this._data.lastValidDay) && (this._data.checkout = l.create(this._data.lastValidDay)),
                0 == l.compare(this._data.checkout, this._data.firstValidDay) && (o = this._options.allowZeroLos ? 0 : 1,
                ...
                s = !0),
                this._data.checkin && (n = _.diff(t, this._data.checkin)) <= 0 && (this._data.checkin = null),
                this._data.checkin || (o = this._options.allowZeroLos ? 0 : 1,
            ...
            r.checkin = !0),
            s && (this._options.syncLegacy && B.search.setDate_("checkout", this._data.checkout.toString(), {
                referrer: "search/dates/model"
            }),
            this._data.editing_checkout = this._data.checkout,
            r.checkout = !0),
            (a || s) && (this._data.length_of_stay = this._data.checkin && this._data.checkout && _.interval(this._data.checkin, this._data.checkout) - 1),
        ...
        adjustEditingFragment: function(e, t, i, n) {
            ...
            var a = 1
              , s = i + n;
            return "month" == t ? a = 0 : "year" == t && (a = this._data.firstValidDay.year),
            s < a && (s = a),
        ...
        applyEditing: function(e) {
            ...
            "checkin" !== e && "checkout" !== e)
                throw new TypeError("invalid type");
            return this._data["editing_" + e].complete ? _r_(this.setDate(e, this._data["editing_" + e])) : (this.clearDates(),
            _r_(!0))
        },
        clearDates: function() {
            _i_("4ab:f4728cb2"),
            ...
            this._options.syncLegacy && (B.search.setDate_("checkin", "", {
                referrer: "search/dates/model"
            }),
        ...
        validate: function(e) {
            ...
            e = e || {};
            var t, i = !0, n = "";
            (!i || !e.notEmpty || this._data.checkin && this._data.checkout || (i = !1,
            n = "missing-dates"),
            i && !this._data.checkin && this._data.checkout && (i = !1,
            n = "missing-checkin"),
            i && this._data.checkin && !this._data.checkout && (i = !1,
            n = "missing-checkout"),
            i && this._data.checkin) && ((t = this.validateDate("checkin", this._data.checkin)).valid || (i = t.valid,
            n = t.validationError));
            i && this._data.checkout && ((t = this.validateDate("checkout", this._data.checkout)).valid || (i = t.valid,
            n = t.validationError));
            if (i && e.validateTime) {
                var a = new Date(1e3 * B.env.b_timestamp)
                  ...
                  , o = a.getUTCFullYear()
                  , _ = a.getHours() + 2;
                (!this._data.checkin || this._data.checkin.year === o && this._data.checkin.month === r && this._data.checkin.day == s) && this._data.checkinTime <= _ && (i = !1,
                n = "past-time")
            }
            return (e.force || !e.checkOnly && this._valid != i) && (this._valid = i,
        ...
        validateDate: function(e, t, i) {
            ...
            if (!t || void 0 === t.year || void 0 === t.month || void 0 === t.day || isNaN(t.year) || isNaN(t.month) || isNaN(t.day))
                return _r_({
                    valid: !1,
                    validationError: "invalid-data"
                });
            if ("checkin" == e && l.compare(t, this._data.firstValidDay) < 0 || "checkout" == e && 0 == l.compare(t, this._data.firstValidDay))
                return _r_({
                    valid: !1,
                    validationError: "past"
                });
            if ("checkout" == e && i.checkin && (n = _.diff(t, i.checkin)),
            null !== n) {
        ...
        getFallbackDates: function(e) {
            var t, i;
            return _i_("4ab:7009f80e"),
            (i = "checkin" === e ? B.env.b_checkin_date : B.env.b_checkout_date) && (i = i.split("-"),
            t = {
...
booking.jstmpl("fe_search_dates_errors", function() {
    ...
    return _r_(function(i) {
        ...
        return e = function(e) {
            if (_i_("4ab:14c12523"),
            n.MJ(n.MB(r[1])) || n.MJ(n.MC(r[2])) || n.MJ(n.MC(r[3])) || n.MJ(n.MC(r[4])) || n.MJ(n.MC(r[5])) || n.MJ(n.MC(r[6])) || n.MJ(n.MC(r[9]))) {
                e += s[1];
                var t = "";
                t += s[2],
                n.MJ(n.MB(r[1]) + "" == "missing-checkout") || n.MJ(n.MC(r[2])) ? t += [s[3], n.ME(s[4], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[1]) + "" == "missing-checkin") || n.MJ(n.MC(r[3])) ? t += [s[3], n.ME(s[5], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[1]) + "" == "past") || n.MJ(n.MC(r[4])) ? t += [s[3], n.ME(s[6], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[1]) + "" == "checkin_date_to_far_in_the_future") || n.MJ(n.MC(r[5])) ? t += [s[3], n.ME(s[7], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[1]) + "" == "negative-period") || n.MJ(n.MC(r[6])) ? t += [s[3], n.ME(s[8], n.MB, n.MN, null), s[9]].join("") : n.MK(n.MB(r[7])) && n.MJ(n.MB(r[1]) + "" == "exceeds-max-los") && n.MJ(45 == n.MB(r[8])) ? t += [s[3], n.ME(s[10], n.MB, n.MN, null), s[11]].join("") : n.MK(n.MB(r[7])) && (n.MJ(n.MB(r[1]) + "" == "exceeds-max-los") || n.MJ(n.MC(r[9]))) ? t += [s[3], n.ME(s[12], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[7])) && (n.MJ(n.MB(r[1]) + "" == "exceeds-max-los") || n.MJ(n.MC(r[9]))) ? (t += s[13],
                n.MN("fe_max_number_of_nights_error_message", 0),
                t += s[13],
                n.MD(r[8]) ? (t += s[14],
                n.MN("fe_max_number_of_nights_error_message", n.MB(r[8])),
                t += s[13]) : n.MJ(n.MC(r[9])) && n.MJ(n.MC(r[10])) && n.MJ(n.MC(r[10]).max_allowed_los) && (t += s[14],
                n.MN("fe_max_number_of_nights_error_message", n.MG((n.MC(r[10]) || {}).max_allowed_los)),
                t += s[13]),
                t += [s[13], (i.unshift({
                    num: n.MB(r[11])
                }),
                a = n.ME(s[15], n.MB, n.MN, n.MO(n.MC(r[11]), null, s[15])),
                i.shift(),
                a), s[2]].join("")) : n.MJ(n.MB(r[1]) + "" == "missing-dates") && n.MJ(n.MB(r[12])) ? t += [s[3], n.ME(s[16], n.MB, n.MN, null), s[2]].join("") : n.MJ(n.MB(r[1])) && (t += [s[3], n.ME(s[5], n.MB, n.MN, null), s[2]].join("")),
                t += s[17],
                n.MN(r[0], t),
                e += s[1],
                n.MJ(n.MB(r[13]) + "" == "flights") && (e += s[2],
                t = "",
                t += s[3],
                n.MJ(n.MB(r[1]) + "" == "missing-checkout") ? t += [s[18], n.ME(s[19], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "missing-checkin") ? t += [s[18], n.ME(s[20], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "past") ? t += [s[18], n.ME(s[21], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "checkin_date_to_far_in_the_future") ? t += [s[18], n.ME(s[22], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "negative-period") ? t += [s[18], n.ME(s[23], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "missing-dates") ? t += [s[18], n.ME(s[20], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1])) && (t += [s[18], n.ME(s[20], n.MB, n.MN, null), s[3]].join("")),
                t += s[2],
                n.MN(r[0], t),
                e += s[17]),
                e += s[1],
                n.MJ(n.MB(r[13]) + "" == "rentalcars") && (e += s[2],
                t = "",
                t += s[3],
                n.MJ(n.MB(r[1]) + "" == "missing-checkout") ? t += [s[18], n.ME(s[24], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "missing-checkin") ? t += [s[18], n.ME(s[25], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "past") ? t += [s[18], n.ME(s[21], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "checkin_date_to_far_in_the_future") ? t += [s[18], n.ME(s[26], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "negative-period") ? t += [s[3], n.ME(s[27], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "missing-dates") ? t += [s[18], n.ME(s[25], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1]) + "" == "past-time") ? t += [s[18], n.ME(s[28], n.MB, n.MN, null), s[3]].join("") : n.MJ(n.MB(r[1])) && (t += [s[18], n.ME(s[25], n.MB, n.MN, null), s[3]].join("")),
                t += s[2],
                n.MN(r[0], t),
                e += s[17]),
                e += s[1],
                n.MD(r[14]) ? e += [s[29], (i.unshift({
                    class: s[30],
                    height: s[31],
                    name: s[32],
                    width: s[31]
                ...
                a = n.HELPER("icon", i[0]),
                i.shift(),
                a), s[33], n.MC(r[0]), s[34]].join("") : (e += s[2],
                i.unshift({
                ...
                e = function(e) {
                    ...
                    n.MD(r[42])) {
                        e += s[36],
                        n.MD(r[16]) && (e += s[37],
                        n.MN(r[15], [s[38], n.MB(r[16]), s[39], n.MB(r[17]), s[40]].join("")),
                        e += s[41]),
                        e += s[36],
                        n.MD(r[18]) && (e += s[37],
                        n.MN(r[15], [n.MB(r[15]), s[42], n.MB(r[18]), s[39], n.MB(r[19]), s[40]].join("")),
                        e += s[41]),
                        e += s[36],
                        n.MD(r[20]) && (e += s[37],
                        n.MN(r[15], [n.MB(r[15]), s[42], n.MB(r[20]), s[39], n.MB(r[21]), s[40]].join("")),
                        e += s[41]),
                        e += s[36],
                        n.MD(r[22]) && (e += s[37],
                        n.MN(r[15], [n.MB(r[15]), s[42], n.MB(r[22]), s[39], n.MB(r[23]), s[40]].join("")),
                        e += s[41]),
                        e += s[36],
                        n.MD(r[24]) && (e += s[37],
                        n.MN(r[15], [n.MB(r[15]), s[42], n.MB(r[24]), s[39], n.MB(r[25]), s[40]].join("")),
                        e += s[41]),
                        e += s[36],
                        n.MD(r[26]) && (e += s[43]),
                        e += s[44];
                        var t = n.MB(r[27]);
                        n.MJ(t + "" == "small") && (e += s[45]),
                        (n.MJ(n.MB(r[28])) || n.MJ(n.MB(r[29])) || n.MJ(n.MB(r[30]))) && (e += s[46]),
                        n.MD(r[31]) && (e += s[47]),
                        n.MJ(n.MB(r[32])) && (e += [s[48], n.F.entities(n.MC(r[32])), n.F.entities(n.MC(r[33])), s[49]].join("")),
                        n.MJ(n.MB(r[28])) && n.MJ(n.MB(r[34])) && (e += [s[50], n.F.entities(n.MC(r[34])), s[49]].join("")),
                        (n.MJ(n.MC(r[35]) + "" == "book") || n.MJ(n.MC(r[35]) + "" == "tpi_book")) && (e += s[51]),
                        e += [n.F.entities(n.MC(r[36])), s[52]].join(""),
                        n.MD(r[37]) && (e += [s[53], n.F.entities(n.MC(r[37])), s[54]].join("")),
                        n.MD(r[15]) && (e += [n.MC(r[15]), s[49]].join("")),
                        n.MD(r[38]) && (e += s[55]),
                        e += s[56],
                        n.MD(r[28]) ? e += [s[57], n.F.entities(n.MC(r[28])), s[58]].join("") : n.MD(r[29]) ? e += [s[59], n.F.entities(n.MC(r[29])), s[60]].join("") : n.MD(r[30]) && (e += s[61],
                        n.MD(r[39]) ? e += n.F.entities(n.MC(r[39])) : e += s[62],
                        e += [s[60], n.MC(r[30]), s[63]].join("")),
                        n.MD(r[40]) && (e += s[64]),
                        n.MD(r[41]) && (e += [s[65], n.MC(r[41]), s[66]].join("")),
                        n.MD(r[42]) && (e += [s[67], n.MC(r[42]), s[68]].join("")),
                        n.MD(r[40]) && (e += [s[69], n.MC(r[40]), s[68]].join("")),
                        n.MD(r[40]) && (e += s[70]),
                        n.MD(r[31]) && (e += [s[71], n.ME(s[72], n.MB, n.MN, null), s[73]].join("")),
                        e += s[70],
                        n.MD(r[26]) && (e += s[70]),
                        e += s[74]
                    }
                    ...
                    n.MN(r[15], void 0),
                    e += s[74],
                    n.MN("fe_banner__banners_count", n.MI(n.MB(r[43])) + n.MI(1)),
                    e += s[76],
                    n.MJ(n.MC(r[35]) + "" == "book") && n.MJ(n.track_experiment_stage("HBaMEAbXDMUBdOYZbKZTSfXPRQYO", 2)) ? e += s[74] : n.MJ(n.track_experiment_stage("HBaMEAbXDMUBdOYZbKZTSfXPRQYO", 1)) && (e += s[74]),
                    e += [s[76], "", s[74]].join(""),
                    _r_(e)
                }(e),
                i.shift(),
...
B.define("component/search/group/group", function(t, e, i) {
    _i_("4ab:5801d550"),
    booking.jstmpl("search_group_group_html", function() {
        _i_("4ab:edc4b85c");
        ...
        return _r_(function(f) {
            ...
            function s(e) {
                ...
                for (var r, o = 1, _ = s.length; o <= _; o++) {
                    ...
                    e += g[20],
                    p.MD(m[7]) && (e += g[167]),
                    e += [g[168], p.F.entities(p.MC(m[49])), g[169], (f.unshift({
                    ...
                    e += g[176],
                    p.MD(m[46]) ? e += [g[177], p.ME(g[178], p.MB, p.MN, null), g[97]].join("") : p.MD(m[43]) ? e += [g[177], p.ME(g[179], p.MB, p.MN, null), g[97]].join("") : p.MD(m[7]) && (e += [g[177], p.ME(g[180], p.MB, p.MN, null), g[97]].join("")),
                    e += g[181];
                    var l = o
                      , d = s
                      , h = _
                    ...
                    _ = s.length; o <= _; o++)
                        ...
                        p.MJ(r + "" != "") && p.MJ(r + "" == "" + u.value) && (e += g[82]),
                        e += g[183],
                        p.MJ(p.MB(m[7])) || p.MJ(p.MB(m[43])) ? e += [g[184], (f.unshift({
                            num_years: u.value
                        }),
                        b = p.ME(g[185], p.MB, p.MN, p.MO(u.value, null, g[185])),
                        f.shift(),
                        b), g[177]].join("") : (e += [g[184], u.value].join(""),
            ...
            function o(e) {
                return _i_("4ab:60b6d2dc"),
                e += g[20],
                p.MK(p.MB(m[19])) ? (e += g[21],
                p.MD(m[7]) || (e += g[64],
                p.MD(m[21]) || (e += g[65]),
                e += g[66],
                p.MD(m[22]) && (e += g[61]),
                e += g[67],
                p.MD(m[22]) ? e += [g[68], p.F.entities(p.MC(m[23])), g[69]].join("") : e += g[70],
                ...
                e = function(e) {
                    ...
                    p.MD(m[7]) && (e += g[73]);
                    e += g[74],
                    p.MD(m[22]) ? e += [g[75], p.F.entities(p.MC(m[23])), g[76]].join("") : e += g[77];
                    ...
                    for (var i, n = 1, a = t.length; n <= a; n++)
                        ...
                        e += g[83],
                        p.MD(m[24]) ? e += (f.unshift({
                            num_rooms: i.value
                        }),
                        b = p.ME(g[84], p.MB, p.MN, p.MO(i.value, null, g[84])),
                        f.shift(),
                        b) : e += i.value,
                        e += g[85];
                    f.shift(),
                ...
                e += g[63]) : e += [g[92], p.F.entities(p.MC(m[18])), g[93]].join(""),
                e += g[2],
                _r_(e)
            }
            function _(e) {
                return _i_("4ab:593fbe2e"),
                e += g[20],
                p.MK(p.MB(m[19])) && (e += g[21],
                ...
                e = function(e) {
                    _i_("4ab:b27e41ae"),
                    e += [g[23], p.F.entities(p.MC(m[9])), g[24], p.F.html(p.MC(m[10])), g[25]].join(""),
                    p.MD(m[11]) && (e += [g[26], p.F.html(p.MC(m[11])), g[27]].join(""));
                    e += g[28],
                    p.MD(m[16]) ? (e += [g[29], p.F.entities(p.MC(m[9])), g[30], p.F.entities(p.MC(m[9])), g[31], p.F.entities(p.MC(m[12])), g[32], p.F.entities(p.MC(m[13])), g[33], p.F.entities(p.MC(m[14])), g[34], p.F.entities(p.MC(m[15])), g[35]].join(""),
                    ...
                    f.shift(),
                    b), g[39], p.F.entities(p.MC(m[9])), g[40], p.F.entities(p.MC(m[14])), g[41]].join(""),
                    ...
                    f.shift(),
                    b), g[39], p.F.entities(p.MC(m[9])), g[44], p.F.entities(p.MC(m[9])), g[45], p.F.entities(p.MC(m[14])), g[46], p.F.entities(p.MC(m[10])), g[47]].join("")) : (e += [g[48], p.F.entities(p.MC(m[9])), g[49], p.F.entities(p.MC(m[9])), g[50], p.F.entities(p.MC(m[12])), g[51], p.F.entities(p.MC(m[13])), g[52], p.F.entities(p.MC(m[14])), g[53], p.F.entities(p.MC(m[15])), g[54]].join(""),
            ...
            function l(e) {
                ...
                p.MJ(p.MB(m[35])) && (p.MJ(p.MB(m[36])) || p.MJ(p.MB(m[37])))) {
                    if (e += g[149],
                    p.MJ(p.MB(m[7])) || p.MJ(p.MB(m[46])) || (e += g[150],
                    p.MD(m[43]) ? e += [p.ME(g[151], p.MB, p.MN, p.MO(p.MC(m[35]), null, g[151])), g[2]].join("") : p.MD(m[45]) ? (p.MN(m[44], p.DATE(p.MB(m[45]), "short_date", "", "", "")),
                    p.MJ(1 == p.MB(m[35])) ? e += [(f.unshift({
                        date: p.MB(m[44])
                    }),
                    b = p.ME(g[152], p.MB, p.MN, null),
                    f.shift(),
                    b), g[2]].join("") : e += [(f.unshift({
                        date: p.MB(m[44])
                    }),
                    b = p.ME(g[153], p.MB, p.MN, null),
                    f.shift(),
                    b), g[2]].join("")) : p.MJ(1 == p.MB(m[35])) ? e += [p.ME(g[154], p.MB, p.MN, null), g[2]].join("") : e += [p.ME(g[155], p.MB, p.MN, null), g[2]].join(""),
                    e += g[109]),
                    e += g[156],
                    p.MN("fe_child_i", 0),
                    e += g[157],
                    p.MJ(0 < p.MB(m[47])) && (e += g[97],
                    p.MJ(1 == p.MB(m[47])) && (e += [g[158], p.ME(g[159], p.MB, p.MN, null), g[160], p.ME(g[161], p.MB, p.MN, null), g[162]].join("")),
                    e += g[163],
                    p.MJ(1 == p.MB(m[47])) ? e += [p.ME(g[164], p.MB, p.MN, null), g[2]].join("") : e += [p.ME(g[165], p.MB, p.MN, null), g[2]].join(""),
                    e += g[166]),
                    e += g[156],
                    p.MD(m[37]))
                        e += g[97],
                        ...
                        e = function(e) {
                            ...
                            for (var i, n = 1, a = t.length; n <= a; n++) {
                                ...
                                f.shift(),
                                b), g[171]].join(""),
                                p.MJ(p.MB(m[46])) && p.MJ(i + "" == "") && (e += g[172]),
                                e += g[173],
                                p.MD(m[46]) ? e += g[174] : e += g[175],
                                e += g[176],
                                p.MD(m[46]) ? e += [g[177], p.ME(g[178], p.MB, p.MN, null), g[97]].join("") : p.MD(m[43]) ? e += [g[177], p.ME(g[179], p.MB, p.MN, null), g[97]].join("") : p.MD(m[7]) && (e += [g[177], p.ME(g[180], p.MB, p.MN, null), g[97]].join("")),
                                e += g[181];
                                var s, r = n, o = t, _ = a, l = s;
                                for (t = p.seq(0, p.MB(m[50])) || [],
                                f.unshift({
                                    i: null
                                }),
                                n = 1,
                                a = t.length; n <= a; n++)
                                    ...
                                    p.MJ(i + "" != "") && p.MJ(i + "" == "" + s.value) && (e += g[82]),
                                    e += g[183],
                                    p.MJ(p.MB(m[7])) || p.MJ(p.MB(m[43])) ? e += [g[184], (f.unshift({
                                        num_years: s.value
                                    }),
                                    b = p.ME(g[185], p.MB, p.MN, p.MO(s.value, null, g[185])),
                                    f.shift(),
                                    b), g[177]].join("") : (e += [g[184], s.value].join(""),
                                    p.MD(m[51]) && (e += p.ME(g[186], p.MB, p.MN, null)),
                                    e += g[177]),
                                    e += g[187];
                                f.shift(),
                    ...
                    e += g[156],
                    p.MJ(p.MB(m[7])) || p.MK(p.MB(m[46])) || (e += g[97],
                    p.MK(p.MB(m[47])) && (e += [g[189], p.ME(g[190], p.MB, p.MN, null), g[191]].join("")),
                    e += g[19]),
                    e += g[192]
                } else
                    p.MD(m[46]) && (e += g[193]);
            ...
            e += g[2],
            p.MJ(p.MC(m[2]) + "" == "searchresults") && p.MJ(p.MC(m[3])) && p.MK(p.MC(m[3]).b_children_total) && p.MJ(p.MC(m[4]) + "" == "family") && (e += g[4],
            p.MN(m[1], [g[5], p.ME(g[6], p.MB, p.MN, null), g[7], p.ME(g[8], p.MB, p.MN, null), g[9]].join("")),
            e += g[2]),
            e += g[10],
            p.MD(m[6]) && (e += g[4],
            p.MN(m[5], [g[11], p.ME(g[12], p.MB, p.MN, null), g[9]].join("")),
            e += g[2]),
            e += g[13],
            e += g[14],
            e += g[14],
            ...
            p.MD(m[7]) && (e += g[16]),
            e += g[17],
            p.MJ(0 == p.MB(m[27])) && (e += g[4],
            p.MJ(p.MB(m[26])) && p.MJ(p.MB(m[7])) || (e += g[18],
            e = p.MD(m[20]) ? _(e += g[19]) : o(e += g[19]),
            e += g[18],
            e += g[4]),
            e += g[20]),
            e += g[94],
            p.MK(p.MB(m[34])) ? (e += g[95],
            p.MD(m[20]) ? (e += g[19],
            p.MN(m[28], p.ME(g[96], p.MB, p.MN, null)),
            e += g[19],
            p.MJ(p.MB(m[30])) && p.MK(p.MB(m[31])) && (e += g[97],
            ...
            p.MD(m[22]) && (e += g[102]),
            e += g[103],
            p.MD(m[22]) ? e += [g[104], p.F.entities(p.MC(m[23])), g[105]].join("") : e += g[106],
            e += g[107],
            p.MD(m[33]) ? e += p.ME(g[108], p.MB, p.MN, null) : e += p.ME(g[96], p.MB, p.MN, null),
            e += g[109]),
            e = function(e) {
                _i_("4ab:0e69ddfc"),
                e += g[2],
                p.MD(m[7]) && (e += g[73]),
                e += [g[110], p.ME(g[111], p.MB, p.MN, null), g[112]].join(""),
                p.MD(m[22]) ? e += [g[113], p.F.entities(p.MC(m[23])), g[114]].join("") : e += g[115],
                e += g[116],
                p.MD(m[6]) && (e += [g[117], p.F.html(p.MC(m[5])), g[112]].join("")),
                e += g[118];
                ...
                for (var i, n = 1, a = t.length; n <= a; n++)
                    ...
                    b = p.ME(g[121], p.MB, p.MN, p.MO(i.value, null, g[121])),
                    f.shift(),
                    b) : e += i.value,
                    e += g[122];
                return f.shift(),
                e += g[123],
                p.MD(m[25]) && (e += [g[4], (f.unshift({
                    class: g[87],
                    name: g[88],
                    width: g[89]
                }),
            ...
            e += g[18],
            e += g[63]) : e += [g[124], p.F.entities(p.MC(m[32])), g[93]].join(""),
            e += g[17],
            p.MK(p.MB(m[52])) && (e += g[18],
            p.MN("fe_sb_group_has_children", p.MB(m[35]) && (p.MB(m[36]) || p.MB(m[37]))),
            e += g[125],
            ...
            e += g[19]) : p.MJ(p.MB(m[41])) && p.MK(p.MB(m[30])) && p.MK(p.MB(m[31])) && (e += g[97],
            ...
            p.MD(m[22]) && (e += g[102]),
            e += g[103],
            p.MD(m[22]) ? e += [g[133], p.F.entities(p.MC(m[23])), g[105]].join("") : e += g[134],
            e += [g[135], p.ME(g[128], p.MB, p.MN, null), g[136]].join("")),
            e = function(e) {
                _i_("4ab:15870e17"),
                e += g[2],
                p.MD(m[7]) && (e += g[73]),
                e += [g[137], p.ME(g[138], p.MB, p.MN, null), g[112]].join(""),
                p.MD(m[22]) ? e += [g[139], p.F.entities(p.MC(m[23])), g[140]].join("") : e += g[141],
                e += g[142],
                p.MD(m[7]) || (e += [g[143], p.F.html(p.MC(m[1])), g[144]].join("")),
                e += g[145];
                ...
                for (var i, n = 1, a = t.length; n <= a; n++)
                    ...
                    e += g[120],
                    p.MJ(p.MB(m[24])) && p.MJ(0 == i.value) ? e += [g[97], p.ME(g[146], p.MB, p.MN, null), g[19]].join("") : p.MJ(p.MB(m[24])) ? e += [g[97], (f.unshift({
                        num_kids: i.value
                    }),
                    b = p.ME(g[147], p.MB, p.MN, p.MO(i.value, null, g[147])),
                    f.shift(),
                    b), g[19]].join("") : e += [g[97], i.value, g[19]].join(""),
                    e += g[122];
                return f.shift(),
                e += g[123],
                p.MD(m[25]) && (e += [g[4], (f.unshift({
            ...
            e += g[18],
            e += g[148],
            p.MK(p.MB(m[52]) || p.MB(m[53])) && p.MJ(p.MB(m[7])) && (e = function(e) {
                if (_i_("4ab:403e925b"),
                e += g[4],
                p.MJ(p.MB(m[35])) && (p.MJ(p.MB(m[36])) || p.MJ(p.MB(m[37])))) {
                    if (e += g[149],
                        ...
                        e = function(e) {
                            ...
                            for (var i, n = 1, a = t.length; n <= a; n++) {
                                ...
                                for (var l, n = 1, a = t.length; n <= a; n++)
                                    f[0].i = l = t[n - 1],
                                    e += [g[182], p.F.entities(l.value), g[53]].join(""),
                                    p.MJ(i + "" != "") && p.MJ(i + "" == "" + l.value) && (e += g[82]),
                                    e += g[183],
                                    p.MJ(p.MB(m[7])) || p.MJ(p.MB(m[43])) ? e += [g[184], (f.unshift({
                                        num_years: l.value
                                    }),
                                    b = p.ME(g[185], p.MB, p.MN, p.MO(l.value, null, g[185])),
                                    f.shift(),
                                    b), g[177]].join("") : (e += [g[184], l.value].join(""),
                                    p.MD(m[51]) && (e += p.ME(g[186], p.MB, p.MN, null)),
                                    e += g[177]),
                                    e += g[187];
                                f.shift(),
            ...
            e += g[63]),
            e += g[194],
            p.MK(p.MB(m[52]) || p.MB(m[53]) || p.MB(m[7])) && p.MJ(p.MB(m[46])) && (e = l(e += g[18]),
            e += g[20]),
            e += g[17],
            p.MJ(p.MB(m[27])) && (e += g[18],
            p.MJ(p.MB(m[26])) && p.MJ(p.MB(m[7])) || (e += g[97],
            e = p.MD(m[20]) ? _(e += g[195]) : o(e += g[195]),
            e += g[97],
            e += g[18]),
            e += g[20]),
            e += g[17],
            p.MK(p.MB(m[58])) && (e += g[196],
            p.MD(m[20]) ? (e += g[19],
            ...
            p.MD(m[22]) && (e += g[200]),
            e += g[67],
            p.MD(m[22]) ? e += [g[201], p.F.entities(p.MC(m[23])), g[69]].join("") : e += g[202],
            e += [g[203], p.ME(g[197], p.MB, p.MN, null), g[166]].join("")),
            e = function(e) {
                _i_("4ab:3dd465e9"),
                e += g[204],
                p.MD(m[7]) && (e += g[73]),
                e += g[205],
                p.MD(m[22]) ? e += [g[206], p.F.entities(p.MC(m[23])), g[207]].join("") : e += g[208],
                e += g[209];
            ...
            e += g[17],
            p.MJ(p.MB(m[7])) && (e += g[4],
            e = p.MD(m[20]) ? (i = e += g[18],
            _i_("4ab:420c5fe3"),
            i += g[20],
            p.MK(p.MB(m[19])) && (i += g[21],
            p.MN(m[8], p.ME(g[22], p.MB, p.MN, null)),
            i += g[18],
            f.unshift({
                fe_bui_stepper_additional_attrs: g[60],
            ...
            n = i,
            _i_("4ab:d3f49533"),
            n += [g[23], p.F.entities(p.MC(m[9])), g[24], p.F.html(p.MC(m[10])), g[25]].join(""),
            p.MD(m[11]) && (n += [g[26], p.F.html(p.MC(m[11])), g[27]].join("")),
            n += g[28],
            p.MD(m[16]) ? (n += [g[29], p.F.entities(p.MC(m[9])), g[30], p.F.entities(p.MC(m[9])), g[31], p.F.entities(p.MC(m[12])), g[32], p.F.entities(p.MC(m[13])), g[33], p.F.entities(p.MC(m[14])), g[34], p.F.entities(p.MC(m[15])), g[35]].join(""),
            ...
            b = p.F.html(p.ME(g[43], p.MB, p.MN, null)),
            f.shift(),
            b), g[39], p.F.entities(p.MC(m[9])), g[44], p.F.entities(p.MC(m[9])), g[45], p.F.entities(p.MC(m[14])), g[46], p.F.entities(p.MC(m[10])), g[47]].join("")) : (n += [g[48], p.F.entities(p.MC(m[9])), g[49], p.F.entities(p.MC(m[9])), g[50], p.F.entities(p.MC(m[12])), g[51], p.F.entities(p.MC(m[13])), g[52], p.F.entities(p.MC(m[14])), g[53], p.F.entities(p.MC(m[15])), g[54]].join(""),
            ...
            _i_("4ab:cb94c1de"),
            t += g[20],
            p.MK(p.MB(m[19])) ? (t += g[21],
            p.MD(m[7]) || (t += g[64],
            p.MD(m[21]) || (t += g[65]),
            t += g[66],
            p.MD(m[22]) && (t += g[61]),
            t += g[67],
            p.MD(m[22]) ? t += [g[68], p.F.entities(p.MC(m[23])), g[69]].join("") : t += g[70],
            t += [g[71], p.ME(g[22], p.MB, p.MN, null), g[72]].join("")),
            t = function(e) {
                _i_("4ab:78465fc5"),
                e += g[4],
                p.MD(m[7]) && (e += g[73]),
            ...
            t += g[63]) : t += [g[92], p.F.entities(p.MC(m[18])), g[93]].join(""),
            t += g[2],
            _r_(t)),
            e += g[4],
            e += g[20]),
            ...
            p.MD(m[7]) && (e += g[91]),
            e += g[194],
            p.MK(p.MB(m[52]) || p.MB(m[53]) || p.MB(m[7]) || p.MB(m[46])) && (e = l(e += g[18]),
            e += g[20]),
            e += g[211],
            a = _r_(e),
            a += g[212],
    ...
    i.exports = n.extend({
        init: function() {
            ...
            this.$el.on("change", '[data-group-infants-count=""]', this.groupInfantsChange.bind(this)),
            this.renderEl = this.$el.find('[data-render=""]')[0],
            this.template = B.jstmpl("search_group_group_html"),
            this.$form.on("change", ".b-booker-type__input_business-booker", this.businessBookerSelected.bind(this)),
            this.modelInit(),
            "index" === B.env.b_action && "sessionStorage"in window && !r.childrenAges.length) {
                var e;
                try {
        ...
        groupChildrenChange: function(e) {
            ...
            "mywishlist" == B.env.b_action && this.customgoalForWishlist(2),
            i.val() > t ? o.customGoal("INFddKNKNKPBDJJHMVGPLTLReASdVLT", 4) : o.customGoal("INFddKNKNKPBDJJHMVGPLTLReASdVLT", 3),
            _r_()
        },
        ...
        render: function() {
            ...
            this.options.childrenAgesHide && (t.fe_sb_group_children_ages_hide = 1),
            this.options.infantsHide && (t.fe_sb_group_infants_hide = 1),
            this.options.useBUIStepper && (t.fe_sb_group_use_bui_stepper = 1),
            this.options.buiSteppersAccessible && (t.fe_sb_group_bui_steppers_accessible = 1),
            ...
            this.options.descriptiveDropdowns && (t.fe_sb_group_descriptive_dropdowns = 1),
            this.options.universalDesign && (t.fe_sb_universal_design = 1),
            this.options.removeDuplicateIds && (t.fe_remove_duplicate_ids = 1),
            this.options.searchBoxUniqueId && (t.fe_sb_unique_id = this.options.searchBoxUniqueId),
            ...
            this.options.sbChildAgeBrackets && (t.fe_sb_show_children_age_bracket = this.options.sbChildAgeBrackets),
            this.options.sbMandatoryChildAges && (t.fe_sb_mandatory_child_ages = this.options.sbMandatoryChildAges),
            this.options.sbChildAgesUIUpdate && (t.fe_sb_child_ages_ui_update = this.options.sbChildAgesUIUpdate);
            ...
            "msie" === B.env.b_browser && B.env.b_browser_version <= 8 && (e.onBeforeElUpdated = function(e, t) {
                ...
                return i && t.setAttribute(jQuery.expando, i),
                _r_(!0)
            }
            ),
            this._isRendered = !0,
        ...
        businessBookerSelected: function() {
            _i_("4ab:cdcb7c24"),
            this.groupAdultsChanged || this.model.group.set({
                key: "adults_count",
                value: 1
            }),
            _r_()
    ...
    $.extend(n.prototype, {
        ...
        set: function(e, t) {
            ...
            if ("children_count" == e.key)
                if (this.data.children_ages || (this.data.children_ages = []),
                0 == e.value)
                    ...
                    for (var i = this.data.children_ages.length; i < e.value; i++)
                        this.data.default_empty_age_to ? this.data.children_ages.push(this.data.default_empty_age_to) : this.data.children_ages.push("");
                else
                    this.data.children_ages.length > e.value && this.data.children_ages.splice(e.value, this.data.children_ages.length - e.value);
            else
                e.hasOwnProperty("i") ? (this.data[e.key] || (this.data[e.key] = []),
                this.data[e.key][e.i] = e.value) : this.data[e.key] = e.value;
        ...
        validate: function(e) {
            ...
            if ((e = e || {}).groupLimit) {
                var n = 0;
                this.data && this.data.adults_count && (n += parseInt(this.data.adults_count)),
                this.data && this.data.children_ages && (n += this.data.children_ages.length),
                n > e.groupLimit && (t = !1,
                i = "over-limit")
            }
            if (this.data.children_ages.length) {
                for (var a = !1, s = 0; s < this.data.children_ages.length; s++)
                    "" !== this.data.children_ages[s] && null !== this.data.children_ages[s] || (a = !0);
                a && (t = !1,
                i = "children-ages",
                r.customGoal("INFddKNKNKPBDJJHMVGPLTLReASdVLT", 2))
            }
            return (this.valid != t || "children-ages" === i && !t) && (this.valid = t,
        ...
        modelChange: function(e) {
            ...
            case "business":
                ...
                break;
            case "family":
                this.data.adults_count = 1 == this.data.adults_count ? 2 : this.data.adults_count,
                this.data.children_ages && 0 != this.data.children_ages.length || (this.data.children_ages = [this.data.default_empty_age_to]);
                break;
            case "group":
                this.data.adults_count = 1 == this.data.adults_count ? 2 : this.data.adults_count,
                this.data.children_ages = []
        ...
        isGroupSearch: function() {
            return _i_("4ab:c6d8e948"),
            _r_(!!(2 < this.data.adults_count || this.data.children_ages && this.data.children_ages.length || this.data.rooms_count && 1 < this.data.rooms_count))
        },
        emit: function(e, t) {
            _i_("4ab:9fb010e7"),
            t = t || {},
    ...
    $.extend(a.prototype, {
        getPopularNearbySuggestions: function() {
            ...
            if (this.rawData && this.rawData.length)
                return this.rawData = this.rawData.slice(0, 5),
                this.formattedData = this.rawData.filter(function(e) {
                    return _i_("4ab:268335d0"),
                    _r_(e.name && e.country)
                }).map(function(e) {
                    return _i_("4ab:def56af1"),
                    _r_({
                        label: e.name,
                ...
                this.formattedData[0] && n.fe_popular_destinations_nearby_title && (this.formattedData[0].section_title = n.fe_popular_destinations_nearby_title,
                this.formattedData[0].section_title_class = "sb-popular-nearby-title"),
...
B.define("search/recent-search/model", function(e, t, i) {
    ...
    $.extend(a.prototype, {
        getRecentSearchSuggestions: function() {
            ...
            if (this.rawData && this.rawData.length) {
                ...
                return this.rawData.filter(function(e) {
                    return _i_("4ab:9cfb6757"),
                    _r_(e.b_dest_short_name)
                }).flatMap(function(t) {
                    _i_("4ab:76240c4d"),
                ...
                this.formattedData[0] && n.fe_recent_search_title && (this.formattedData[0].section_title = n.fe_recent_search_title,
                this.formattedData[0].section_title_class = "sb-recent-search-title"),
                _r_(this.formattedData)
            }
            _r_()
        },
        modelInit: function() {
            _i_("4ab:7a8bd6a5"),
            this.rawData = n.fe_recent_search,
            _r_()
        }
    }),
    i.exports = a,
...
function() {
    ...
    B.when({
        ...
        _i_("4ab:8a408d12");
        var t, i = e("et"), n = e("search/searchbox/events"), a = $("#ss").closest("form");
        function s(e) {
            _i_("4ab:d18e6e24"),
            e ? (t = $('<input type="hidden" value="1" name="is_recent_search" />'),
            a.append(t)) : t && t.remove(),
            _r_()
        }
        n.on(n.SEARCHBOX_DESTINATION_SELECTED, function(e) {
            _i_("4ab:39eec20f"),
            e && e.destination && e.destination.isRecentSearch ? (i.customGoal("cCHObXKeNJfOEJcCcCcCC", r),
            s(!0)) : s(!1),
            _r_()
        }),
        _r_()
    ...
    i.exports = n.extend({
        init: function() {
            ...
            var e = this.$el.closest("form")
              , t = e.attr("data-sb-id");
            if (this.$checkbox = this.$el.find("[name=sb_entire_place]"),
        ...
        updateHiddenFields: function() {
            _i_("4ab:65daace2"),
            this.$el.is(":visible") && this.$checkbox.prop("checked") ? this.model.setFields("filters", [{
                name: "nflt",
                value: [r, o].join(";")
...
_i_("4ab:2280c42a"),
B.define("searchbox/dynamic-los-per-dest-tracking-batches", function(e, t, i) {
    _i_("4ab:19e95599");
    var n = e("et")
      , a = e("server-data")
      , s = 1
...
B.when({
    ...
    function _() {
        ...
        var e = o()
          , t = (_i_("4ab:48ef3014"),
        _r_(parseInt(s.max_allowed_los || 0, 10)) || e)
          , i = a.getOption("maxLos")
          , n = t;
        a.configure("maxLos", n),
        i !== n && a.validate({
            force: !0
        }),
        _r_()
    ...
    i.on("change", function(e) {
        _i_("4ab:20973cc8"),
        e && "destination" === e.group && (s = n.data.max_los_data || {},
        _()),
        _r_()
    }),
    i.on("validation:lengthOfStay", function(e) {
        _i_("4ab:ea9ac6ee"),
        e && "dates" === e.group && e.lengthOfStay && function(e) {
            _i_("4ab:836d34d5");
            var t = (_i_("4ab:0b2558ac"),
            _r_(s.has_extended_los ? s.experiment : ""))
              , i = o();
            e && t && (r.trackSearchExtendedUfi(t),
            i < e && r.trackAttemptSearchingForExtendedLos(e, r.SITE_TYPES.DESKTOP, t)),
            _r_()
        }(e.lengthOfStay),
        _r_()
    }),
...
B.define("search/searchbox/analytics", function(e, n, t) {
    ...
    n.send = function(e, t, i) {
        ...
        !window.ga)
            return _r_();
        window.ga("send", "event", "Searchbox", B.env.b_action, e, t, i),
        _r_()
    }
    ,
...
B.define("search/searchbox/model", function(d, e, t) {
    ...
    $.extend(r.prototype, {
        ...
        setFields: function(e, t) {
            _i_("4ab:ac5771fa"),
            this.fieldGroups[e] = t,
            _r_()
        },
        getMode: function() {
            return _i_("4ab:2e4cae8d"),
            _r_(this.mode)
        },
        setMode: function(e) {
            _i_("4ab:112fc3f2"),
        ...
        hasFlag: function(e) {
            return _i_("4ab:a263e608"),
            _r_(e in this.flags)
        },
        getFlag: function(e) {
            return _i_("4ab:ab8b5c0e"),
            _r_(this.flags[e])
        },
        updateFlags: function(e) {
            _i_("4ab:3466ef2a");
            var t = n.parse(e);
            Object.assign(this.flags, t),
            _r_()
        },
        validate: function() {
            _i_("4ab:608d75f9");
            var e = this.validators.filter(function(e) {
                return _i_("4ab:e68ae526"),
                _r_(e.call())
            });
...
B.define("search/searchbox/events", function(e, t, i) {
    ...
    return n.SEARCHBOX_SUBMIT_SUCCESS = "searchbox_submit_success",
...
B.define("component/search/searchbox/searchbox", function(i, e, t) {
    ...
    t.exports = a.extend({
        init: function() {
            ...
            this.options.isFirstVisible && this.model.hasFlag("sticky")) && i("search/searchbox/searchbox-sticky-controller").getController().setElement(this.$form);
            ...
            this.shouldShowSearchOverlay = this.model.getFlag("AEJPAcBacPONDcFGHT") && this.$searchOverlay.length,
            this.shouldShowSearchOverlay && (this.$searchOverlay.on("click", this.searchOverlayClick.bind(this)),
            ...
            function() {
                ...
                var t = function(e) {
                    _i_("4ab:5df413d1"),
                    this.options.changeCtaCopyOnInputChange && e && ("dates" !== e.group || "checkout" === e.type) && (this.$form.find(".js-sb-submit-text").html(this.options.changeCtaCopyOnInputChange),
                    this.model.off("change", t)),
                    _r_()
                }
                .bind(this);
                this.model.on("change", t),
                _r_()
            }
            .bind(this)(),
            _r_()
        ...
        initCurrentCountryField: function() {
            ...
            this.$onlyCurrentCountry.length && (e = this.$onlyCurrentCountry.is(":checked"),
            this.$onlyCurrentCountry.bind("change", this.onlyCurrentCountryChange.bind(this)),
            this.model.use("destination"),
            this.model.destination.initOnlyCurrentCountry(e)),
            _r_()
        ...
        updateHiddenFields: function() {
            ...
            this.hiddenFields && this.hiddenFields.forEach(function(e) {
                _i_("4ab:cb94b31b"),
                e.$node.remove(),
                e.$node = null,
                _r_()
            ...
            this.$form.find("input").filter(function() {
                return _i_("4ab:db7cc3c8"),
                _r_(a && -1 != l.indexOf(this.name) || -1 != n.indexOf(this.name))
            }).remove(),
        ...
        selectFirstFromAutocomplete: function() {
            ...
            e && !e.selected && e.dataset && e.dataset.length && this.model.destination.set(e.dataset[0]),
            _r_()
        },
        formSubmit: function(e) {
            ...
            this.shouldShowSearchOverlay ? this.showSearchOverlay() : this.shouldShowSearchPageOverlay ? this.pageOverlay.show(this.model.destination.data.ss_raw) : this.shouldShowSRPP && this.SRPPOverlay.show(this.model.destination.data.ss_raw),
            this.options.actionForGroup && this.model.group && "function" == typeof this.model.group.isGroupSearch && this.model.group.isGroupSearch() && this.$form.attr("action", this.options.actionForGroup),
        ...
        showSearchOverlay: function() {
            _i_("4ab:a7b810f1"),
            this.$searchOverlay.addClass("-visible"),
            _r_()
        },
        hideSearchOverlay: function() {
            _i_("4ab:ae61912d"),
            this.$searchOverlay.removeClass("-visible"),
            _r_()
        }
    }),
    _r_()
    ...
    Object.assign(r.prototype, {
        setElement: function(e) {
            ...
            this.bottomPosition) {
                var t = e.offset()
                  , i = e.outerHeight();
                if (t && t.top + i > this.bottomPosition)
                    return _r_()
            }
            this.$el = e,
            this.recalculate(),
        ...
        clickOnWindow: function(e) {
            if (_i_("4ab:a1d20162"),
            this.$sticky && this.$sticky.length) {
                var t = e.target
                  , i = this.$sticky.get(0);
        ...
        updateStatus: function() {
            _i_("4ab:e7cec903"),
            !this.visible && this.$window.scrollTop() >= this.bottomPosition ? (this.visible = !0,
            this.emit("show")) : this.visible && this.$window.scrollTop() < this.bottomPosition && (this.visible = !1,
            this.emit("hide")),
            _r_()
        },
        windowScroll: function(e) {
            if (_i_("4ab:65bfc59a"),
            null === this.bottomPosition)
                return _r_();
            this.updateStatus(),
            _r_()
        }
...
B.define("component/search/searchbox/searchbox-sticky", function(e, t, i) {
    ...
    i.exports = n.extend({
        ...
        hardShow: function() {
            _i_("4ab:3835991a"),
            this.$el.addClass("-visible-1 -visible-2"),
            _r_()
        },
        hide: function(e) {
            _i_("4ab:fc5db946"),
...
B.define("search/searchbox/searchbox-deny-focus-controller", function(e, t, i) {
    ...
    function s(e) {
        ...
        n(this.el).on("focus change blur", "a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), *[tabindex], *[contenteditable]", t),
    ...
    (s.prototype = s.prototype || {}).eventHandler = function(e) {
        ...
        this._timeoutId = null,
        "focusout" === e.type || "blur" === e.type ? this._timeoutId = setTimeout(this.deny.bind(this), 100) : this.allow(),
        _r_()
    }
    ,
...
B.define("search/searchbox/searchbox-sticky-controller-v2", function(e, t, i) {
    ...
    u.prototype.getElementsToHide = function() {
        ...
        this.$elementsToHide = n().add(e).add(t),
        _r_()
    }
    ,
    u.prototype.setShowPosition = function() {
        ...
        this.showScrollPosition = Math.ceil(e.top) + -8,
        _r_()
    }
    ,
    u.prototype.scrollHandler = function() {
        if (_i_("4ab:b0bfd7df"),
        d.scrollTop() > this.showScrollPosition) {
            if (a.stage(this.expHash, 1),
            0 === this.expVariant)
                return d.off("resize orientationchange", this.throttledSetPosition),
...
B.define("component/search/group/children-ages-tooltip", function(e, t, i) {
    ...
    i.exports = s.extend({
        ...
        addEventListeners: function() {
            ...
            void 0 !== B.hotel.Events && (r.on(B.hotel.Events.RT.LIGHTBOX_CLOSE, this.hideTooltip.bind(this)),
...
B.define("component/search/group/add-children-tooltip", function(e, t, i) {
    ...
    i.exports = _.extend({
        init: function() {
            _i_("4ab:b89a9bb1"),
            o && this.$el.data("add-children-tooltip") && (this.showTooltip(),
            B.browserStorageHandler.addSessionValue("gs_sb_add_children_tooltip", 1),
            o = !1,
        ...
        showTooltip: function() {
            ...
            var e = this.$el;
            r && r.hide(),
            (r = n.fly.dropdown.extend({
                defaults: {
                    position: a,
                    content: function() {
                        return _i_("4ab:bd350a17"),
                        _r_(e.data("add-children-tooltip"))
                    },
                    extraClass: s
                },
                actions: {
                ...
                init: function() {
                    ...
                    this.bind(this.events.show, function() {
                        _i_("4ab:7720bd99"),
                        n("." + s).delegate(".fly-dropdown-close", "click", function(e) {
                            _i_("4ab:edc671d6"),
                            r.hide(),
                            _r_()
                        }),
...
B.define("component/search/group/occupancy-pricing-tooltip", function(e, t, i) {
    ...
    i.exports = _.extend({
        init: function() {
            _i_("4ab:ad805250"),
            o && this.$el.data("occupancy-pricing-tooltip") && (this.showTooltip(),
    ...
    return _r_(function(e) {
        ...
        t = function(e) {
            ...
            n.MD(s[28])) {
                e += a[5],
                n.MD(s[2]) && (e += a[6],
                n.MN(s[1], [a[7], n.MB(s[2]), a[8], n.MB(s[3]), a[9]].join("")),
                e += a[10]),
                e += a[5],
                n.MD(s[4]) && (e += a[6],
                n.MN(s[1], [n.MB(s[1]), a[11], n.MB(s[4]), a[8], n.MB(s[5]), a[9]].join("")),
                e += a[10]),
                e += a[5],
                n.MD(s[6]) && (e += a[6],
                n.MN(s[1], [n.MB(s[1]), a[11], n.MB(s[6]), a[8], n.MB(s[7]), a[9]].join("")),
                e += a[10]),
                e += a[5],
                n.MD(s[8]) && (e += a[6],
                n.MN(s[1], [n.MB(s[1]), a[11], n.MB(s[8]), a[8], n.MB(s[9]), a[9]].join("")),
                e += a[10]),
                e += a[5],
                n.MD(s[10]) && (e += a[6],
                n.MN(s[1], [n.MB(s[1]), a[11], n.MB(s[10]), a[8], n.MB(s[11]), a[9]].join("")),
                e += a[10]),
                e += a[5],
                n.MD(s[12]) && (e += a[12]),
                e += a[13];
                var t = n.MB(s[13]);
                n.MJ(t + "" == "small") && (e += a[14]),
                (n.MJ(n.MB(s[14])) || n.MJ(n.MB(s[15])) || n.MJ(n.MB(s[16]))) && (e += a[15]),
                n.MD(s[17]) && (e += a[16]),
                n.MJ(n.MB(s[18])) && (e += [a[17], n.F.entities(n.MC(s[18])), n.F.entities(n.MC(s[19])), a[18]].join("")),
                n.MJ(n.MB(s[14])) && n.MJ(n.MB(s[20])) && (e += [a[19], n.F.entities(n.MC(s[20])), a[18]].join("")),
                (n.MJ(n.MC(s[21]) + "" == "book") || n.MJ(n.MC(s[21]) + "" == "tpi_book")) && (e += a[20]),
                e += [n.F.entities(n.MC(s[22])), a[21]].join(""),
                n.MD(s[23]) && (e += [a[22], n.F.entities(n.MC(s[23])), a[23]].join("")),
                n.MD(s[1]) && (e += [n.MC(s[1]), a[18]].join("")),
                n.MD(s[24]) && (e += a[24]),
                e += a[25],
                n.MD(s[14]) ? e += [a[26], n.F.entities(n.MC(s[14])), a[27]].join("") : n.MD(s[15]) ? e += [a[28], n.F.entities(n.MC(s[15])), a[29]].join("") : n.MD(s[16]) && (e += a[30],
                n.MD(s[25]) ? e += n.F.entities(n.MC(s[25])) : e += a[31],
                ...
                n.MD(s[26]) && (e += a[39]),
                n.MD(s[17]) && (e += [a[40], n.ME(a[41], n.MB, n.MN, null), a[42]].join("")),
                e += a[39],
                n.MD(s[12]) && (e += a[39]),
                e += a[43]
            }
            ...
            e += a[45],
            n.MJ(n.MC(s[21]) + "" == "book") && n.MJ(n.track_experiment_stage("HBaMEAbXDMUBdOYZbKZTSfXPRQYO", 2)) ? e += a[43] : n.MJ(n.track_experiment_stage("HBaMEAbXDMUBdOYZbKZTSfXPRQYO", 1)) && (e += a[43]),
            e += [a[45], "", a[43]].join(""),
            _r_(e)
        }(t),
        e.shift(),
...
B.define("component/search/group/group-with-modal", function(e, t, i) {
    ...
    i.exports = n.extend({
        ...
        addEventListeners: function() {
            ...
            .bind(this)),
            this.$toggle.on("mousedown", function(e) {
                _i_("4ab:4dec3563"),
            ...
            .bind(this)),
            this.options.groupShowCloseButton && this.$el.find("button#doneBtn").on("click", function(e) {
                if (_i_("4ab:b84d1aa2"),
                !this.modalOpen)
                    return _r_();
                this.toggleModal(!1),
        ...
        modelValidation: function(e) {
            _i_("4ab:8410cdba"),
            e && !e.valid && "children-ages" === e.validationError && this.toggleModal(!this.modalOpen),
            _r_()
        },
        toggleModal: function(e) {
            ...
            this.modalOpen = e,
            this.$modal[0] && "xp__guests__inputs-container" === this.$modal[0].id && e) {
...
B.define("component/search/searchbox/searchbox-xp", function(e, t, i) {
    ...
    i.exports = n.extend({
        ...
        addCalendarsLogic: function() {
            ...
            B.env.b_hijri_calendar_available && i.addClass("c2-wrapper-s-has-hijri-calendar"),
        ...
        onChangeMode: function(e) {
            _i_("4ab:83bb50be"),
            "accommodation" == e && (this.model.setFormAction(B.env.fe_sb_accommodation_search_url),
            this.model.destination && this.model.destination.configure({
                validate: !1
            }),
            this.model.emit("change", {})),
            _r_()
...
B.define("component/search/dates/prompt", function(e, t, i) {
    ...
    i.exports = s.extend({
        init: function() {
            ...
            this.$el.find(".sb-dates-prompt__close").on("click", this.dismiss.bind(this)),
            this.isDismissed())
                return _r_();
            o && this.isLandingScrollStarted() ? o.once(o.UI_LANDING_SCROLL_COMPLETED, this.show.bind(this)) : this.show(),
            _r_()
        },
        show: function() {
            if (_i_("4ab:eaede618"),
        ...
        isLandingScrollStarted: function() {
            return _i_("4ab:f6bb9fa1"),
            _r_(B.sr && B.sr.landingScrollStarted || B.env.fe_landing_scroll_started)
        }
    }),
    _r_()
}),
B.define("component/search/dates/date-field-select", function(e, t, i) {
    ...
    var n = e("component")
      ...
      , C = "-editing"
      , k = "-editing-select"
      , D = "sb-date-field__select_disabled"
      , x = "sb-date-field__select_focused"
      , w = "sb-date-field__value_empty";
    i.exports = n.extend({
        init: function() {
            _i_("4ab:fc0fa748"),
            this.options = a(this.el, {
            ...
            this.$monthYearSelect.on("change", this.handleMonthYearChange.bind(this)),
        ...
        handleSelectBlur: function(e) {
            _i_("4ab:e615df80"),
            $(e.delegateTarget).removeClass(x),
            this.toggleMode(!1),
            this.inputBlurTimer = setTimeout(function() {
                _i_("4ab:061f7dd9"),
                this.applyChange(),
        ...
        renderMonthYearField: function() {
            ...
            h += n ? this.getMonthsHtml(o, l, _, d, n.month, n.year) : this.getMonthsHtml(o, l, _, d),
            a.html(h),
        ...
        renderFields: function() {
            ...
            var e = this.options.modelMode
              ...
              , a = n || i
              , s = n && !n.complete;
            if (this.renderMonthYearField.call(this),
            ...
            !s && i) {
                ...
                this.$field.removeClass(B),
                this.$display.html(b.format(i, r)),
                this.$iconDay.html(b.format(i, "{day_of_month}"))
            }
            s || i || (this.$field.addClass(B),
            this.$display.html(this.$display.attr("data-placeholder")),
            this.$iconDay.html(this.$iconDay.attr("data-placeholder"))),
            null !== t.extendedDate && t.extendedDate ? this.$extendDate.html(o.translations("sxp_sbox_property_count_flexible", null, {
                num: t.extendedDate
...
B.define("component/search/dates/single-calendar", function(e, t, i) {
    ...
    i.exports = n.extend({
        init: function() {
            ...
            this.checkinPlaceholder = this.$form.find('[data-mode="checkin"] [data-display]').data("placeholder") || _.translations("checkin_date"),
            this.$checkoutPlaceholder = this.$form.find('[data-mode="checkout"] [data-display]'),
            this.checkoutPlaceholder = this.$checkoutPlaceholder.data("placeholder") || _.translations("checkout_date"),
            this.$inputDateTimeFields = this.$form.find(".xp__date-time"),
            this.dateFormat = this.$form.find(".sb-date-field__display").data("date-format") || "date_with_weekday",
            ...
            this.keepCalOpenOnDateSelect = !!this.$el.data("keep-cal-open-on-date-select"),
            this.separateTriggers = !!this.$el.data("separate-triggers"),
            this.keepInputFieldSelected = !!this.$el.data("keep-input-field-selected"),
            this.separateTriggers && (this.closeOnDateSelect = !0,
        ...
        bindEvents: function() {
            _i_("4ab:aebbbe74"),
            this.$inputDateTimeFields.on("click", function(e) {
                if (_i_("4ab:b26a124c"),
                h(e.target).is("select"))
                    return _r_();
                if (this.mountCalendar(),
                this.separateTriggers) {
                    ...
                    this.calendarOpen && n === i ? this.hideCalendar() : (this.showCalendar(),
                    this.keepInputFieldSelected && (this.$inputDateTimeFields.removeClass("focus"),
                    t.addClass("focus")))
                } else
            ...
            h("body").on("click", function(e) {
                ...
                this.keepCalOpen || t.hasClass("xp__dates") || n || a || this.hideCalendar(),
                _r_()
            }
            .bind(this)),
            this.$form.find(".xp__date-time").one("mouseenter touchstart", this.mountCalendar.bind(this)),
            this.separateTriggers && this.model.on("init", function() {
                _i_("4ab:29a7aa8c"),
                this.onModelChange({
                    checkin: !0,
                    checkout: !0
        ...
        getMinMaxDates: function() {
            ...
            var e = new Date
              , t = new Date;
            return B.env.b_search_max_months ? (t.setMonth(t.getMonth() + B.env.b_search_max_months),
        ...
        initCalendar: function() {
            ...
            var e = {
                ...
                onDateChange: function(e) {
                    _i_("4ab:f931129e"),
                    this.closeOnDateSelect || (this.settingDatesFromUserInteraction = !0);
                    var t = e.startDate
                      , i = e.endDate;
                    t && (t = r.create({
                        year: t.getFullYear(),
                    ...
                    i || this.separateTriggers || this.$checkoutPlaceholder.text(this.checkoutPlaceholder)),
                    i && (i = r.create({
                        year: i.getFullYear(),
                        month: i.getMonth(),
                        day: i.getDate()
                    ...
                    e.startDate === e.clickedDate && o.trackEvent(B.Search.TrackingEvents.CHECKIN_DATEPICKER),
                    e.endDate === e.clickedDate && o.trackEvent(B.Search.TrackingEvents.CHECKOUT_DATEPICKER),
            ...
            this.calendarInstance = window.BUI.createInstance("Calendar", this.$calendar[0], e),
            _r_()
        },
        renderSelectedCustom: function() {},
        mountCalendar: function() {
            _i_("4ab:8e0cafba"),
            this.calendarMounted || (this.calendarInstance.mount(),
            this.calendarMounted = !0),
            _r_()
        },
        onModelChange: function(e) {
            if (_i_("4ab:d7c28836"),
            this.settingDatesFromUserInteraction)
                return _r_();
            if (e.checkin || e.checkout) {
                ...
                this.calendarInstance._updateDateClassNames && (this.calendarInstance._updateDateClassNames(),
...
B.define("search/dates/date-prices-service", function(e, t, i) {
    _i_("4ab:d913f4fb");
    var n, a = e("fragment"), s = e("promise"), r = e("search-config"), o = {
        propertyId: null,
        searchConfig: null,
        startDate: null,
        endDate: null,
    ...
    function f(e) {
        return _i_("4ab:315515a1"),
        _r_(e ? [e.getFullYear(), ("0" + (e.getMonth() + 1)).slice(-2), ("0" + e.getDate()).slice(-2)].join("-") : null)
    }
    i.exports = {
        init: function(e) {
            _i_("4ab:80c70299"),
        ...
        fetchPrices: function(e) {
            ...
            return _r_(new s(function(o, _) {
                ...
                if (d.checkinAlt && void 0 !== c[l])
                    return _r_(o(c));
                if (!d.checkinAlt && void 0 !== h[f(d.startDate)] && void 0 !== h[f(d.endDate)])
                    return _r_(o(h));
                var e = {
                ...
                a.call("hotel.availability_calendar", e).then(function(e) {
                    if (_i_("4ab:0c0a8fb4"),
                    !e || e && void 0 === e.days)
                        return _r_(_());
                    var t, i, n, a, s;
                    for (var r in e.days)
                        ...
                        c[n] || (c[n] = {}),
                        c[n][a] = s,
                        _r_()) : (h[i] = t.b_avg_price_pretty || null,
                        1 < t.b_min_length_of_stay && u(i, t.b_min_length_of_stay));
                    o(d.checkinAlt ? c : h),
                    _r_()
                }).catch(_),
                _r_()
...
B.define("searchbox/calendar-with-prices-core", function(e) {
    _i_("4ab:2f092a3a");
    var b, g, m = e("jstmpl"), M = e("search/dates/date-prices-service"), a = e("server-data"), v = m.translations("sr_calendar_checkout_only_tooltip_info"), y = new Date;
    function t(e, t) {
        return _i_("4ab:e72f659e"),
        this.service = M,
        this.$calendarEl = e,
        this.buiCalendar = t,
        _r_(this)
    ...
    function B(e) {
        return _i_("4ab:315515a11"),
        _r_(e ? [e.getFullYear(), ("0" + (e.getMonth() + 1)).slice(-2), ("0" + e.getDate()).slice(-2)].join("-") : null)
    }
    return y.setHours(0, 0, 0, 0),
    t.prototype.initCalendarWithPrices = function(e) {
        ...
        t.getDayMarkup = function(e) {
            ...
            var _, l = g && e < g, d = o && o[n] || "&mdash;", h = o && void 0 !== o[n] && null !== o[n], c = o && void 0 !== o[s] && null !== o[s], u = h || l ? "" : " calendar-day--unavailable", f = M.getMinLosForInterval(b, n);
        ...
        .bind(this),
        this.buiCalendar = window.BUI.createInstance("Calendar", this.$calendarEl[0], t),
        "function" == typeof e ? e(this.buiCalendar) : this.buiCalendar.mount(),
        this.hideLoading(),
        _r_()
    }
    ,
    t.prototype.bindMonthChangeHandlers = function() {
        _i_("4ab:fc176f8d"),
        this.$calendarEl.on("click", ".bui-calendar__control--prev, .bui-calendar__control--next", function() {
            _i_("4ab:c5238e49"),
            setTimeout(function() {
                _i_("4ab:e78e9e27"),
                this.getPricesAndRender(),
                _r_()
            }
            .bind(this), 1),
            _r_()
    ...
    t.prototype.isLoading = function() {
        return _i_("4ab:b8601c81"),
        _r_(0 < this.$calendarEl.find(".calendar-dates-prices-loader:visible").length)
    }
    ,
    t.prototype.showInfoMessage = function(e) {
        ...
        var i = e;
        if (void 0 === e && this.defaultInfoMessage && (i = this.defaultInfoMessage),
        void 0 === i)
            return _r_();
        t.html(i),
        _r_()
    ...
    t.prototype.setCheckinDate = function(e, t) {
        ...
        b = e,
        t ? g && B(b) === B(g) || (g = b,
        this.getPricesAndRender(void 0, void 0, g)) : g && (g = void 0),
...
B.define("component/search/dates/single-calendar-with-prices", function(e, t, i) {
    ...
    i.exports = o.extend({
        init: function() {
            ...
            this.showAvForSelectedCheckin = this.$el.data("show-av-for-selected-checkin"),
            this.isCheckInChangedByUser = !1,
            this.isCheckOutChangedByUser = !1,
            this.calendarWithPrices = new n(this.$calendar,this.calendarInstance),
            this.calendarWithPrices.service.init(a.b_hotel_id),
            this.calendarWithPrices.initCalendarWithPrices(function(e) {
                _i_("4ab:f45f77a2"),
                this.calendarInstance = e,
                this.separateTriggers || this.onModelChange({
                    checkin: !0,
                    checkout: !0
                }),
                this.mountCalendar(),
        ...
        onModelChange: function(e) {
            _i_("4ab:4d46b12d"),
            o.prototype.onModelChange.apply(this, arguments);
            ...
            if (t && !i && (this.isCheckInChangedByUser = !0,
            this.isCheckOutChangedByUser && _.customGoal(l, 3)),
            i && this.isCheckInChangedByUser && (_.customGoal(l, 2),
            this.isCheckOutChangedByUser = !0),
            t && (this.showMinLosWarning || this.showAvForSelectedCheckin) && this.calendarWithPrices.setCheckinDate(t, this.showAvForSelectedCheckin && this.isCheckInChangedByUser),
            this.showAvForSelectedCheckin && this.isCheckInChangedByUser && t) {
                ...
                i && this.checkinAvModeOn && this.calendarWithPrices.isLoading() && _.customGoal(l, 1),
        ...
        renderSelectedCustom: function() {
            ...
            this.calendarInstance && this.calendarInstance.state && this.calendarInstance.state.startDate && this.calendarInstance.state.endDate && this.calendarInstance.state.startDate < this.calendarInstance.state.endDate && this.calendarWithPrices) {
                ...
                if (e && this.showMinLosWarning)
                    return _r_('<div class="bui-text">' + s.translations("sr_calendar_min_night_stay_footer", e, {
                        num_nights: e
                    }) + "</div>")
            }
            _r_()
    ...
    t.exports = n.extend({
        ...
        checkBoxClick: function() {
            ...
            this.$checkboxes.on("click", function(e) {
                ...
                r(e.target).prop("checked") ? (this.defaultSelected = !1,
                "0" === t && (this.defaultSelected = !0),
                this.selectCheck(e.target),
                _ && o.goalWithValue("js_flexible_dates_checked_" + ("0" === t ? "exact" : t), 1)) : (this.defaultSelected = !0,
                this.selectCheck(this.$defaultCheckBox),
                _ && o.goalWithValue("js_flexible_dates_unchecked_" + ("0" === t ? "exact" : t), 1)),
                _r_()
            }
            .bind(this)),
            _r_()
        ...
        selectCheck: function(e) {
            _i_("4ab:335cff2f"),
            this.$checkboxes.prop("checked", !1).next().removeClass("ced-checked"),
            r(e).prop("checked", !0).next().addClass("ced-checked"),
            r(e).focus(),
            _ ? this.handleCalendarDatesTextMdot(+r(e).val()) : this.handleCalendarDatesTextWww(+r(e).val()),
            _r_()
        },
        handleCalendarDatesTextMdot: function(e) {
            ...
            this.defaultSelected && t.trigger("SEARCHBOX_CALENDAR_EXTEND_DATE_DEFAULT_SELECTED", e),
            _r_()
        },
        handleCalendarDatesTextWww: function(e) {
            _i_("4ab:fd1ee4af");
            var t = i("search/searchbox/model");
            this.model = t.getInstance(this.$el.closest("[data-sb-id]").data("sb-id")),
            this.model.use("dates"),
            this.model.dates.setExtendedDate(e),
            this.defaultSelected && s.trigger("SEARCHBOX_CALENDAR_EXTEND_DATE_DEFAULT_SELECTED", e),
            _r_()
        }
    }),
    _r_()
...
B.when({
    ...
    var t = e("et")
      , i = e("server-data")
      , n = "TZUfdKNKNKPRVfEeSPGOaYdYO"
      , a = "TZUfCDWOODXaJPeTJLBWHZHT";
    "mdot" === i.b_site_type || i.fe_is_tdot ? (_i_("4ab:ed3c715c"),
    e("event-bus").on("SEARCHBOX_CALENDAR_OPENED", function() {
        _i_("4ab:0d054f40"),
        t.stage(a, 1),
        "index" === i.b_action && t.stage(a, 3),
        _r_()
    })) : (_i_("4ab:6a059874"),
    e("events").on("SEARCHBOX_CALENDAR_OPENED", function(e) {
        _i_("4ab:5af52618"),
        t.stage(n, 1),
        i.b_is_landing_page && t.stage(n, 2),
        _r_()
    })),
    _r_(),
    _r_()
...
B.when({
    ...
    function r() {
        ...
        setTimeout(function() {
            _i_("4ab:0de9ca2d"),
            (t.is(":focus") || i.is(":focus")) && d() || !t.hasClass("-visible") || (t.removeClass("-visible"),
            o()),
            _r_()
        }, 0),
        _r_()
    ...
    function l(e) {
        ...
        40 === e.keyCode)
            ...
            !function() {
                if (_i_("4ab:5bf0afc8"),
                0 === s ? s = n.length - 1 : ($(n[s]).removeClass("favourite-hover"),
                s--),
                0 === s)
                    return i.focus(),
                    _r_();
            ...
            /[a-zA-Z0-9-_ ]/.test(t) && (i.val(e.key),
            i.focus(),
            r())
        }
        _r_()
    ...
    function d() {
        return _i_("4ab:9f3a423f"),
        _r_(i.val() == e || "" == i.val())
    }
    i.on("change keyup paste blur", r),
    i.focusin(function() {
        if (_i_("4ab:a48837cc"),
        B.env.fe_popular_nearby_replace_favorite)
            return _r_();
    ...
    i.keydown(function(e) {
        _i_("4ab:476e84f7"),
        !d() || 40 !== e.keyCode && 38 !== e.keyCode || (t.focus(),
        l(e));
        _r_()
    }),
    t.blur(r),
    ...
    t.click(function(e) {
        _i_("4ab:50eb64b3");
        var t = e.target;
        if (t.classList.contains("favourite-heading") || t.classList.contains("search-suggestion__title"))
            return _r_();
