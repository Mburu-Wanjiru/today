...
function() {
    ...
    var e, t, i;
    !function(p) {
        var o, a, d, h, v = {}, _ = {}, m = {}, g = {}, n = Object.prototype.hasOwnProperty, r = [].slice, y = /\.js$/;
        function w(e, t) {
            var n, r = B.env && B.env.b_dev_server, i = (n = B.reportError) && "[object Function]" === {}.toString.call(n) && B.reportError.bind(B);
            if (r || !i)
                throw new Error(e);
            i({
                message: e
        ...
        function u(e, t) {
            var n, r, i, o, a, u, s, c, f, l, p, d = t && t.split("/"), h = m.map, v = h && h["*"] || {};
            if (e && "." === e.charAt(0))
                if (t) {
        ...
        function T(e) {
            ...
            return b(v, e) || b(g, e) || w("No " + e, "almond"),
            v[e]
        }
        function s(e) {
        ...
        d = function(e, t) {
            ...
            return e = i[1],
            o && (n = T(o = u(o, t))),
            o ? e = n && n.normalize ? n.normalize(e, (r = t,
            function(e) {
                return u(e, r)
            }
            )) : u(e, t) : (o = (i = s(e = u(e, t)))[0],
            e = i[1],
            o && (n = T(o))),
            {
                f: o ? o + "!" + e : e,
        ...
        o = function(e, t, n, r) {
            var i, o, a, u, s, c, f = [], l = typeof n;
            if (r = r || e,
            "undefined" === l || "function" === l) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t,
                s = 0; s < t.length; s += 1)
                    "require" === (o = (u = d(t[s], r)).f) ? f[s] = h.require(e) : "exports" === o ? (f[s] = h.exports(e),
                    c = !0) : "module" === o ? i = f[s] = h.module(e) : b(v, o) || b(_, o) || b(g, o) ? f[s] = T(o) : u.p ? (u.p.load(u.n, k(r, !0), E(o), {}),
                    f[s] = v[o]) : w(e + " missing " + o, "almond");
                a = n ? n.apply(v[e], f) : void 0,
                e && (i && i.exports !== p && i.exports !== v[e] ? v[e] = i.exports : a === p && c || (v[e] = a))
            } else
                e && (v[e] = n)
        }
        ,
        e = t = a = function(e, t, n, r, i) {
            ...
            if (!e.splice) {
                if ((m = e).deps && a(m.deps, m.callback),
                !t)
                    return;
                t.splice ? (e = t,
                t = n,
            ...
            r = i),
            r ? o(p, e, t, n) : setTimeout(function() {
                o(p, e, t, n)
            }, 4),
            a
        }
...
function(n, r) {
    ...
    s = function(e, t, n) {
        ...
        if ("" === e)
            return null;
        return A("Attempting to use non-numeric value '" + e + "' for translation tag '" + n + "'"),
        0
    }
    ,
    A = function(e, t) {
        e = e || "BHCJS runtime issue",
        r && r.env && r.env.b_dev_server ? (t && console.warn("Template: " + t),
        console.error(e)) : i.error_out && n.onerror && n.onerror("JSTMPL:: " + e, t || "jstmpl", 0)
    }
    ,
    c = function(e) {
    ...
    p = function(e, t, n) {
        ...
        for (t.length; ; ) {
            ...
            for (var a = i + 1; a < o; ++a) {
                ...
                if (!("0" <= u && u <= "9" || "a" <= u && u <= "z" || "_" == u || "/" == u || "-" == u))
                    break
            }
            a === o ? (f(e, t.substring(i + 1, o), n + 1),
            r = o + 1) : (e.push(t.substring(i, a)),
            r = a)
        }
    }
    ,
    f = function(e, t, n) {
        if (0 < n) {
            if (42 <= n)
                return console.warn("Detected excessive recursion in tag sequence: %s, returning '%s'", interpolate_tags.slice(1, 42).join(" "), value),
                void e.push(t);
            if (t === d[n - 1])
                return console.warn("Detected self-referential tag '%s', returning '%s'", value, value),
                void e.push(t)
        }
        d[n] = t;
        ...
        if (u && t in u)
            return void ("string" == typeof (o = u[t]) && -1 !== o.indexOf("{") ? p(e, o, n + 1) : e.push(o));
        e.push("")
    }
    ,
    k = function(e) {
        ...
        fn: {
            ...
            seq: function(e, t, n) {
                ...
                /^[A-Za-z]$/.exec(e) || /^[A-Za-z]$/.exec(t))
                    if ((1 !== e.length || 1 !== t.length || /[a-z]/.exec(e) && !/[a-z]/.exec(t) || /[A-Z]/.exec(e) && !/[A-Z]/.exec(t)) && A("Invalid range '" + e + "'-'" + t + "' in seq()"),
            ...
            sprintf: function() {
                for (var e, t = [].slice.apply(arguments), n = t.splice(0, 1)[0]; e = t.splice(0, 1)[0]; )
                    n = n.replace(/%\w/, e);
                return n
            },
    ...
    (i = function(e, t) {
        ...
        "get_trans"in e && (o.prototype.fn.GET_TRANS = o.prototype.fn.ME = e.get_trans),
        "get_text"in e && (o.prototype.fn.GET_TEXT = o.prototype.fn.MF = e.get_text),
        "get_var_plural"in e && (o.prototype.fn.GET_VAR_PLURAL = o.prototype.fn.VP = e.get_var_plural),
        "get_static_hostname"in e && (o.prototype.fn.STATIC_HOSTNAME = e.get_static_hostname),
        "get_csrf_token"in e && (o.prototype.fn.CSRF_TOKEN = e.get_csrf_token),
...
function(i) {
    ...
    i.jstmpl.translations)
        return;
    var o, r = i.jstmpl, s = i.env, a = function(e, t, n, r) {
        var i = 0
          , o = !(0 !== r && !r);
        if (o) {
            if (/^[0-9]+$/.test(r))
        ...
        var o, a = e.split("/");
        ("" === a[0] && a.shift(),
        1 == a.length) && ("{" === (c = a[0]).charAt(0) && "}" === c.charAt(c.length - 1) && (c = c.substr(1, c.length - 2)),
        a = ["private", c, "name"]);
        ...
        o) {
            ...
            s = f.length; u < s; ++u) {
                var l, p = f[u];
                l = -1 === p.indexOf("/") ? t(p.substr(1, p.length - 2)) : d(p.substr(1, p.length - 2), t, n, r, i),
                o = o.split(p).join(l)
            }
        }
        return o || ""
        ...
        if ("private" === e) {
            var r = (o && o.private || {})[t];
            return r && "string" != typeof r && r.experiment_hash && r.value && (i.et && i.et.stage(r.experiment_hash, 1),
...
function(s) {
    ...
    u = function(e, n) {
        ...
        t && !r ? r = Math.floor(t / (l / f)) : r && !t && (t = Math.floor(r / (f / l))),
        Object.assign(n, {
            width: r || f,
            height: t || l,
            viewBox: s,
    ...
    f = function(e, t, n, r) {
        try {
            ...
            if (window.B && B.env.b_dev_server)
                throw e;
            return ""
        }
    }
...
window.booking && booking.define && booking.jstmpl && (booking.define("jstmpl", function() {
...
function(e, t) {
    e("tmpl_data", [], function() {
        ...
        var u = {};
        function s(e, t, n) {
            void 0 === u[e] ? u[e] = t : (u.b_dev_server && console.warn("SERVER::Trying to override " + e + " with value: " + t),
            n && (u[e] = t))
        }
        function e(e, t) {
            if (t)
...
function(e, t) {
    e("request_info", [], function() {
        ...
        function t() {
            ...
            (n || (n = document.getElementById("req_info"))) && (n.innerHTML !== t && (e = n.innerHTML,
        ...
        return {
            populate: function(e) {
                o(e),
                "string" == typeof e ? (o(e),
                t()) : e instanceof Array && (e.forEach(o),
                t())
            }
        }
    })
    ...
    e("et_debug", [], function() {
        ...
        function i() {
            try {
                ...
                return r && console.log("Error when trying to init et event emitter", "error:", e),
                null
            }
        }
        return {
...
B.define("formatting/date", function(e, a, t) {
    ...
    a.compat = function(e, t) {
        ...
        if (e instanceof Date)
            n = e;
        else if (e && e.indexOf && -1 === e.indexOf(":") && (e += " 00:00"),
        (n = !isNaN(Date.parse(e)) && new Date(e)) || null == e || (e = e.replace(/-/g, "/"),
...
B.define("formatting/time", function(e, t, n) {
    ...
    return {
        locale_format: function(e) {
            ...
            if (e.until = e.until || !1,
            e.no_html = e.no_html || !0,
            e.time.match(/^(?:([0-2]?[0-9])[.: -]?([0-5]?[0-9]))$/).slice(1).forEach(function(e, t) {
...
B.define("event-emitter", function(e, t, r) {
    (function() {
        ...
        function a(e) {
            ...
            if (e.debug && (t.debug = !0,
            t.last = {
                time: 0,
                eventCount: 0
            }),
            e.strict && (t.strict = !0,
            t.strictKeys = e.events,
            !e.events))
                throw new Error("No events defined for emitter " + t.name);
            e.async && (this.emitSync = this.emit,
            this.emit = this.emitNext,
            t.async = !0)
        }
        function p(e, t, n) {
            var r = e._events;
            if (r.strict && r.strictKeys.hasOwnProperty(n))
                return;
        ...
        a.prototype.addListener = function(e, t, n) {
            ...
            return r.strict && p(this, "addListener", e),
            (r.events[e] || (r.events[e] = [])).push(n ? {
                fn: t,
                context: n
            } : t),
            this
        ...
        a.prototype.emit = function(e) {
            var t = this._events;
            if (null == e)
                throw new Error("emit(name): name cant be " + e);
            t.strict && p(this, "emit", e),
            t.debug && this.tick();
            var n = t.events[e];
            if (!n)
                return this;
        ...
        a.prototype.emitNext = function(e) {
            ...
            var t, n, r, i = (t = a.prototype.emit,
            n = this,
            r = arguments,
            function() {
                return t.apply(n, r)
        ...
        a.prototype.tick = function() {
            var e = this._events
              ...
              , n = e.last;
            e.count++,
            5e3 < t - n.time && (e.rate = Math.floor((e.count - n.count) / (t - n.time) / 1e3),
            e.last = {
                time: t,
                count: e.count
            })
...
B.define("promise", function(e, t, l) {
    "undefined" == typeof Promise ? function(e) {
        ...
        function a(n) {
            var r = this;
            if (null === this._state)
                return void this._deferreds.push(n);
            t(function() {
        ...
        o.resolve = function(t) {
            if (t && "object" == typeof t && t.constructor === o)
                return t;
...
B.define("when/core", function(p, e, t) {
    ...
    function n(e) {
        ...
        return l.run = function(e, t) {
            "function" == typeof a ? c = e : a = e || function() {}
            ,
            s = t
        }
        ,
        ...
        n.exports = {
            ...
            handler: function(e) {
                var n, r = function(e) {
                    ...
                    r = a.length; i < r; ++i)
                        t = !1,
                        -1 < (o = (n = a[i]).indexOf(" ")) && (t = n.slice(o + 1),
                        n = n.slice(0, o)),
                        u.push({
                            evt: n,
                            node: t
...
B.define("when/events-view", function(e, t, n) {
    ...
    function l() {
        if (i)
            return;
        i = !0,
        (u = u.filter(f)).length || (s.off("scroll", l),
        s.off("resize", l),
        c = !1),
        setTimeout(function() {
            i = !1
    ...
    n.exports = function(e, t, n, r) {
        var i;
        if (!o(e).length || "function" != typeof t)
            return;
        f(i = [o(e), t, n || this, r]) && u.push(i),
        !c && u.length && (s.on("scroll", l),
        s.on("resize", l),
        c = !0)
    }
}),
    ...
    n.exports = {
        ...
        handler: function(e) {
            if (e instanceof Array)
                return -1 < e.indexOf(B.env.b_action);
    ...
    n.exports = {
        ...
        handler: function(e, t) {
            if (!t.conditions.experiment)
                throw new Error('when: "stage" must come after "experiment" condition');
            return t.stage = e,
            r.stage(t.hash, e),
            !0
        },
...
B.define("when/language", function(e, t, n) {
    n.exports = {
        name: "language",
        handler: function(e) {
            if ("string" != typeof e || "function" != typeof e.split)
                return !1;
...
window.jQuery.cookie = function(e, t, n) {
    ...
    n = n || {},
    null === t && (t = "",
    (n = $.extend({}, n)).expires = -1);
    var u, s = "";
    n.expires && ("number" == typeof n.expires || n.expires.toUTCString) && ("number" == typeof n.expires ? (u = new Date).setTime(u.getTime() + 24 * n.expires * 60 * 60 * 1e3) : u = n.expires,
...
B.define("ga4-tracker-utils", function() {
    ...
    return {
        ...
        isDataLayerDefined: function() {
            if (!a())
                return !1;
            return o(window.dataLayer)
        },
        generateTimestamp: function() {
            if (o(Date) && "function" == typeof Date.now)
                return Date.now();
            return "0"
        },
        readPropFromEnv: c,
        ...
        getParamValueFromAnalyticsString: function(e) {
            var t = "-1";
            if (!o(e))
                return t;
            if (!a())
                return t;
            var n = c("b_analytics_tracking_string");
            if (!o(n))
                return t;
...
B.define("ga4-tracker", function(e) {
    ...
    return {
        trackEventGA: function(e, t) {
            if (!function() {
                if (!n.isWindowDefined() || !n.isDocDefined())
                    return !1;
                if (!n.isDefinedAndNotNull(document.cookie))
                    return !1;
                ...
                return;
            if (!n.isDefinedAndNotNull(e) || !n.isDefinedAndNotNull(t))
                return;
            !function(e) {
                if (!n.isDefinedAndNotNull(e))
                    return;
                if (!n.isDataLayerDefined())
                    return;
...
B.define("ga4-tracker-events", function(e) {
    var c = e("ga4-tracker")
      , f = e("ga4-tracker-utils");
    if (null == c)
        return;
    if (null == f)
        return;
    var t = "change_selection_checkout_your_details"
      , l = "add_payment_info"
      , n = "newsletter_sign_up"
      , r = "app_download"
      , i = "open_app"
      , o = '[data-ga4-track="change_selection"]'
      , a = '[data-ga4-track="newsletter_sign_up"]'
      , u = '[data-ga4-track="app_download_header"]'
      , s = '[data-ga4-track="app_download_footer"]'
    ...
    return {
        changeSelectionCheckout: function() {
            if ("book" !== f.readPropFromEnv("b_action"))
                return;
            if (2 !== f.readPropFromEnv("b_book_stage"))
                return;
            f.attachHandler(o, h, function() {
                c.trackEventGA(t, {})
            })
        },
        processPaymentInfoCheckout: function(e) {
            if ("book" !== f.readPropFromEnv("b_action"))
                return;
            if (3 !== f.readPropFromEnv("b_book_stage"))
                return;
            var t = ""
              , n = "-1"
              , r = "hotel"
              , i = ""
              , o = ""
              , a = f.readPropFromGa4Cache("internal_page_view_checkout_prop_card");
            f.isDefinedAndNotNull(a) && f.isDefinedAndNotNull(a.propertyDetails) && (t = f.isDefinedAndNotNull(a.propertyDetails.name) ? a.propertyDetails.name : f.readPropFromEnv("b_destination_name"),
            f.isDefinedAndNotNull(a.propertyDetails.starRating) && (n = a.propertyDetails.starRating.value),
            f.isDefinedAndNotNull(a.propertyDetails.accommodationType) && (r = a.propertyDetails.accommodationType.type,
            r = f.isDefinedAndNotNull(r) && "string" == typeof r ? r.toLowerCase() : r)),
            f.isDefinedAndNotNull(e) && (i = f.isDefinedAndNotNull(e.payment_method) ? e.payment_method.name : i,
            o = f.isDefinedAndNotNull(e.payment_cc_details) ? e.payment_cc_details.cc_type : o);
            var u = {
                items: [],
                _clear: !0,
                payment_option: o,
              ...
              , s = {
                item_id: f.readPropFromEnv("b_hotel_id"),
                item_name: t,
                affiliation: f.readPropFromEnv("b_aid"),
                index: -1,
                item_brand: f.readPropFromEnv("b_acc_type"),
                item_category: "accommodations",
                item_category2: f.readPropFromEnv("b_countrycode"),
                item_category3: f.readPropFromEnv("b_urlcity"),
                item_category4: f.readPropFromEnv("b_ufi"),
                item_category5: r,
                item_list_name: f.readPropFromEnv("b_destination_name"),
                item_variant: n,
                price: f.getParamValueFromAnalyticsString("final_booking_price") || f.getParamValueFromAnalyticsString("total_cost"),
                quantity: 1
            };
            u.items.push(s),
            c.trackEventGA(l, u)
        ...
        newsletterSignUp: function() {
            f.attachHandler(a, v, function(e) {
                if (!f.isDefinedAndNotNull(e))
                    return;
                c.trackEventGA(n, {
        ...
        appDownload: function() {
            ...
            f.attachHandler(u, h, e),
            f.attachHandler(s, h, e)
        },
        openApp: function() {
            function e() {
                c.trackEventGA(i, {})
            }
            f.attachHandler(p, h, e),
            f.attachHandler(d, h, e)
        }
    }
}),
B.when({
    ...
    if ("1" !== e("server-data").fe_enable_GA4_TRACKING_ON_LEGACY)
        return;
